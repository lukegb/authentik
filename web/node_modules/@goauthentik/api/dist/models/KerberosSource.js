...
exports.KerberosSourceToJSONTyped = KerberosSourceToJSONTyped;
...
function KerberosSourceToJSON(json) {
    return KerberosSourceToJSONTyped(json, false);
}
function KerberosSourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
