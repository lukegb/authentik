...
import {
    ...
    UserObjectPermissionToJSONTyped,
 ...
 */
export function instanceOfUserAssignedObjectPermission(value: object): value is UserAssignedObjectPermission {
...
export function UserAssignedObjectPermissionToJSON(json: any): UserAssignedObjectPermission {
    return UserAssignedObjectPermissionToJSONTyped(json, false);
}

export function UserAssignedObjectPermissionToJSONTyped(value?: Omit<UserAssignedObjectPermission, 'pk'|'uid'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
