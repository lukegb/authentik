...
import { DeviceChallengeRequestFromJSON, DeviceChallengeRequestToJSON, } from './DeviceChallengeRequest';
/**
 * Check if a given object implements the AuthenticatorValidationChallengeResponseRequest interface.
 */
export function instanceOfAuthenticatorValidationChallengeResponseRequest(value) {
    let isInstance = true;
    return isInstance;
}
export function AuthenticatorValidationChallengeResponseRequestFromJSON(json) {
    return AuthenticatorValidationChallengeResponseRequestFromJSONTyped(json, false);
}
export function AuthenticatorValidationChallengeResponseRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function AuthenticatorValidationChallengeResponseRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
