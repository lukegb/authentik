...
export function GroupOAuthSourceConnectionRequestToJSON(json) {
    return GroupOAuthSourceConnectionRequestToJSONTyped(json, false);
}
export function GroupOAuthSourceConnectionRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
