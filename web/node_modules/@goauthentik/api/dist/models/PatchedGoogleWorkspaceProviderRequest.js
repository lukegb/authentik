...
exports.instanceOfPatchedGoogleWorkspaceProviderRequest = instanceOfPatchedGoogleWorkspaceProviderRequest;
exports.PatchedGoogleWorkspaceProviderRequestFromJSON = PatchedGoogleWorkspaceProviderRequestFromJSON;
exports.PatchedGoogleWorkspaceProviderRequestFromJSONTyped = PatchedGoogleWorkspaceProviderRequestFromJSONTyped;
exports.PatchedGoogleWorkspaceProviderRequestToJSON = PatchedGoogleWorkspaceProviderRequestToJSON;
exports.PatchedGoogleWorkspaceProviderRequestToJSONTyped = PatchedGoogleWorkspaceProviderRequestToJSONTyped;
 ...
 */
function instanceOfPatchedGoogleWorkspaceProviderRequest(value) {
    return true;
}
function PatchedGoogleWorkspaceProviderRequestFromJSON(json) {
    return PatchedGoogleWorkspaceProviderRequestFromJSONTyped(json, false);
}
function PatchedGoogleWorkspaceProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PatchedGoogleWorkspaceProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
