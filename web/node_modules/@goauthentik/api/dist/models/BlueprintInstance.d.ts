 ...
 */
export declare function instanceOfBlueprintInstance(value: object): value is BlueprintInstance;
...
export declare function BlueprintInstanceToJSON(json: any): BlueprintInstance;
export declare function BlueprintInstanceToJSONTyped(value?: Omit<BlueprintInstance, 'pk' | 'last_applied' | 'last_applied_hash' | 'status' | 'managed_models' | 'metadata'> | null, ignoreDiscriminator?: boolean): any;
