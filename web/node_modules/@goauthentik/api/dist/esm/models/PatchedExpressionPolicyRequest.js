 ...
 */
export function instanceOfPatchedExpressionPolicyRequest(value) {
    return true;
}
export function PatchedExpressionPolicyRequestFromJSON(json) {
    return PatchedExpressionPolicyRequestFromJSONTyped(json, false);
}
export function PatchedExpressionPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedExpressionPolicyRequestToJSON(json) {
    return PatchedExpressionPolicyRequestToJSONTyped(json, false);
}
export function PatchedExpressionPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
