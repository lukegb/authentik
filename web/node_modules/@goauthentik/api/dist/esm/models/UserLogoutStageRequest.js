 ...
 */
export function instanceOfUserLogoutStageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    return isInstance;
}
export function UserLogoutStageRequestFromJSON(json) {
    return UserLogoutStageRequestFromJSONTyped(json, false);
}
export function UserLogoutStageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UserLogoutStageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
