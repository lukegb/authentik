...
exports.instanceOfPolicyBindingRequest = instanceOfPolicyBindingRequest;
exports.PolicyBindingRequestFromJSON = PolicyBindingRequestFromJSON;
...
exports.PolicyBindingRequestToJSONTyped = PolicyBindingRequestToJSONTyped;
/**
 * Check if a given object implements the PolicyBindingRequest interface.
 */
function instanceOfPolicyBindingRequest(value) {
...
function PolicyBindingRequestFromJSON(json) {
    return PolicyBindingRequestFromJSONTyped(json, false);
}
function PolicyBindingRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PolicyBindingRequestToJSON(json) {
    return PolicyBindingRequestToJSONTyped(json, false);
}
function PolicyBindingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
