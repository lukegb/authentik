 ...
 */
export function instanceOfPatchedPasswordExpiryPolicyRequest(value) {
    return true;
}
export function PatchedPasswordExpiryPolicyRequestFromJSON(json) {
    return PatchedPasswordExpiryPolicyRequestFromJSONTyped(json, false);
}
export function PatchedPasswordExpiryPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedPasswordExpiryPolicyRequestToJSON(json) {
    return PatchedPasswordExpiryPolicyRequestToJSONTyped(json, false);
}
export function PatchedPasswordExpiryPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
