 ...
 */
export function instanceOfSAMLSourceRequest(value) {
...
export function SAMLSourceRequestFromJSON(json) {
    return SAMLSourceRequestFromJSONTyped(json, false);
}
export function SAMLSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'nameIdPolicy': json['name_id_policy'] == null ? undefined : NameIdPolicyEnumFromJSON(json['name_id_policy']),
...
export function SAMLSourceRequestToJSON(json) {
    return SAMLSourceRequestToJSONTyped(json, false);
}
export function SAMLSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
