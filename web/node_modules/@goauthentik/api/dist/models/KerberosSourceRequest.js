...
exports.KerberosSourceRequestToJSONTyped = KerberosSourceRequestToJSONTyped;
...
function KerberosSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'kadminType': json['kadmin_type'] == null ? undefined : (0, KadminTypeEnum_1.KadminTypeEnumFromJSON)(json['kadmin_type']),
...
function KerberosSourceRequestToJSON(json) {
    return KerberosSourceRequestToJSONTyped(json, false);
}
function KerberosSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
