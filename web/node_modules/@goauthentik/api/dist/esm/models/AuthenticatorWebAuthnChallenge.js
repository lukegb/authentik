...
export function AuthenticatorWebAuthnChallengeFromJSON(json) {
    return AuthenticatorWebAuthnChallengeFromJSONTyped(json, false);
}
export function AuthenticatorWebAuthnChallengeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthenticatorWebAuthnChallengeToJSON(json) {
    return AuthenticatorWebAuthnChallengeToJSONTyped(json, false);
}
export function AuthenticatorWebAuthnChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
