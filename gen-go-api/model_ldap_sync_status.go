...
// checks if the LDAPSyncStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LDAPSyncStatus{}
...
func (o LDAPSyncStatus) ToMap() (map[string]interface{}, error) {
