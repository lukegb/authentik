...
exports.instanceOfAuthenticatorStaticChallenge = instanceOfAuthenticatorStaticChallenge;
function AuthenticatorStaticChallengeFromJSON(json) {
    return AuthenticatorStaticChallengeFromJSONTyped(json, false);
}
exports.AuthenticatorStaticChallengeFromJSON = AuthenticatorStaticChallengeFromJSON;
function AuthenticatorStaticChallengeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AuthenticatorStaticChallengeFromJSONTyped = AuthenticatorStaticChallengeFromJSONTyped;
function AuthenticatorStaticChallengeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AuthenticatorStaticChallengeToJSON = AuthenticatorStaticChallengeToJSON;
