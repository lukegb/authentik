 ...
 */
export declare function instanceOfLDAPOutpostConfig(value: object): value is LDAPOutpostConfig;
...
export declare function LDAPOutpostConfigToJSON(json: any): LDAPOutpostConfig;
export declare function LDAPOutpostConfigToJSONTyped(value?: Omit<LDAPOutpostConfig, 'pk' | 'unbind_flow_slug' | 'application_slug'> | null, ignoreDiscriminator?: boolean): any;
