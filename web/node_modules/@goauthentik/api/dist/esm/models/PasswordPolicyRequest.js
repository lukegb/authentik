 ...
 */
export function instanceOfPasswordPolicyRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function PasswordPolicyRequestFromJSON(json) {
    return PasswordPolicyRequestFromJSONTyped(json, false);
}
export function PasswordPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PasswordPolicyRequestToJSON(json) {
    return PasswordPolicyRequestToJSONTyped(json, false);
}
export function PasswordPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
