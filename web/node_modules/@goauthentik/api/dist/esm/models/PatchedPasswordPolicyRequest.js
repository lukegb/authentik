 ...
 */
export function instanceOfPatchedPasswordPolicyRequest(value) {
    let isInstance = true;
    return isInstance;
}
export function PatchedPasswordPolicyRequestFromJSON(json) {
    return PatchedPasswordPolicyRequestFromJSONTyped(json, false);
}
export function PatchedPasswordPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function PatchedPasswordPolicyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
