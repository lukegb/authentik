 ...
 */
export function instanceOfUserLoginStage(value) {
...
export function UserLoginStageFromJSON(json) {
    return UserLoginStageFromJSONTyped(json, false);
}
export function UserLoginStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserLoginStageToJSON(json) {
    return UserLoginStageToJSONTyped(json, false);
}
export function UserLoginStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
