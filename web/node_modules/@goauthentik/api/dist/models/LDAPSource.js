...
exports.LDAPSourceToJSON = exports.LDAPSourceFromJSONTyped = exports.LDAPSourceFromJSON = exports.instanceOfLDAPSource = void 0;
 ...
 */
function instanceOfLDAPSource(value) {
    let isInstance = true;
...
function LDAPSourceFromJSON(json) {
    return LDAPSourceFromJSONTyped(json, false);
}
exports.LDAPSourceFromJSON = LDAPSourceFromJSON;
function LDAPSourceFromJSONTyped(json, ignoreDiscriminator) {
...
function LDAPSourceToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
