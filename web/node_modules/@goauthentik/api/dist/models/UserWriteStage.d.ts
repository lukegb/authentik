 ...
 */
export declare function instanceOfUserWriteStage(value: object): value is UserWriteStage;
...
export declare function UserWriteStageToJSON(json: any): UserWriteStage;
export declare function UserWriteStageToJSONTyped(value?: Omit<UserWriteStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
