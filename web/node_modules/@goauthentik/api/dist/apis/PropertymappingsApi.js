...
exports.PropertymappingsApi = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class PropertymappingsApi extends runtime.BaseAPI {
    /**
    ...
    propertymappingsAllListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedPropertyMappingListFromJSON)(jsonValue));
        });
    }
    /**
     * PropertyMapping Viewset
    ...
    propertymappingsAllRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PropertyMappingFromJSON)(jsonValue));
        });
    }
    /**
     * PropertyMapping Viewset
    ...
    propertymappingsNotificationCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.NotificationWebhookMappingRequestToJSON)(requestParameters.notificationWebhookMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationWebhookMappingFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationWebhookMapping Viewset
    ...
    propertymappingsNotificationListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedNotificationWebhookMappingListFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationWebhookMapping Viewset
    ...
    propertymappingsNotificationPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedNotificationWebhookMappingRequestToJSON)(requestParameters.patchedNotificationWebhookMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationWebhookMappingFromJSON)(jsonValue));
        });
    }
    ...
    propertymappingsSamlPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedSAMLPropertyMappingRequestToJSON)(requestParameters.patchedSAMLPropertyMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SAMLPropertyMappingFromJSON)(jsonValue));
        });
    }
    ...
    propertymappingsScimCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.SCIMMappingRequestToJSON)(requestParameters.sCIMMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SCIMMappingFromJSON)(jsonValue));
        });
    }
    /**
     * SCIMMapping Viewset
    ...
    propertymappingsScimListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedSCIMMappingListFromJSON)(jsonValue));
        });
    }
    /**
     * SCIMMapping Viewset
    ...
    propertymappingsScimPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedSCIMMappingRequestToJSON)(requestParameters.patchedSCIMMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SCIMMappingFromJSON)(jsonValue));
        });
    }
    ...
    propertymappingsScopeCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ScopeMappingRequestToJSON)(requestParameters.scopeMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ScopeMappingFromJSON)(jsonValue));
        });
    }
    /**
     * ScopeMapping Viewset
    ...
    propertymappingsScopeListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedScopeMappingListFromJSON)(jsonValue));
        });
    }
    /**
     * ScopeMapping Viewset
    ...
    propertymappingsScopePartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedScopeMappingRequestToJSON)(requestParameters.patchedScopeMappingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ScopeMappingFromJSON)(jsonValue));
        });
    }
