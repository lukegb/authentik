...
export function instanceOfGoogleWorkspaceProviderRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('delegatedSubject' in value) || value['delegatedSubject'] === undefined)
        return false;
...
export function GoogleWorkspaceProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
