...
exports.PaginatedGoogleWorkspaceProviderMappingListToJSONTyped = PaginatedGoogleWorkspaceProviderMappingListToJSONTyped;
...
function PaginatedGoogleWorkspaceProviderMappingListToJSON(json) {
    return PaginatedGoogleWorkspaceProviderMappingListToJSONTyped(json, false);
}
function PaginatedGoogleWorkspaceProviderMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
