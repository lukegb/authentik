...
export function PaginatedGoogleWorkspaceProviderUserListToJSON(json) {
    return PaginatedGoogleWorkspaceProviderUserListToJSONTyped(json, false);
}
export function PaginatedGoogleWorkspaceProviderUserListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
