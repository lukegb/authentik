...
export function PaginatedUserKerberosSourceConnectionListToJSON(json) {
    return PaginatedUserKerberosSourceConnectionListToJSONTyped(json, false);
}
export function PaginatedUserKerberosSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
