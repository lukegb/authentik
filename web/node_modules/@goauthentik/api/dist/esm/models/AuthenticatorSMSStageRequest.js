 ...
 */
export function instanceOfAuthenticatorSMSStageRequest(value) {
...
export function AuthenticatorSMSStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthenticatorSMSStageRequestToJSON(json) {
    return AuthenticatorSMSStageRequestToJSONTyped(json, false);
}
export function AuthenticatorSMSStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
