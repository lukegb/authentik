...
exports.PaginatedBrandListToJSONTyped = PaginatedBrandListToJSONTyped;
...
function PaginatedBrandListToJSON(json) {
    return PaginatedBrandListToJSONTyped(json, false);
}
function PaginatedBrandListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
