...
exports.RACProviderRequestToJSONTyped = RACProviderRequestToJSONTyped;
/**
...
function RACProviderRequestToJSON(json) {
    return RACProviderRequestToJSONTyped(json, false);
}
function RACProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
