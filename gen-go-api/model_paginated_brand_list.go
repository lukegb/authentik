...
// checks if the PaginatedBrandList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedBrandList{}
...
func (o PaginatedBrandList) ToMap() (map[string]interface{}, error) {
