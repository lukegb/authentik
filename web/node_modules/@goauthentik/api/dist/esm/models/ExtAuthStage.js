 ...
 */
export function instanceOfExtAuthStage(value) {
...
export function ExtAuthStageFromJSON(json) {
    return ExtAuthStageFromJSONTyped(json, false);
}
export function ExtAuthStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ExtAuthStageToJSON(json) {
    return ExtAuthStageToJSONTyped(json, false);
}
export function ExtAuthStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
