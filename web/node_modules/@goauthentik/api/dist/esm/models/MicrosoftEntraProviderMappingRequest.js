...
export function MicrosoftEntraProviderMappingRequestToJSON(json) {
    return MicrosoftEntraProviderMappingRequestToJSONTyped(json, false);
}
export function MicrosoftEntraProviderMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
