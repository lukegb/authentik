...
export function instanceOfAuthenticatorTOTPChallenge(value) {
    ...
    if (!('pendingUserAvatar' in value) || value['pendingUserAvatar'] === undefined)
        return false;
    if (!('configUrl' in value) || value['configUrl'] === undefined)
        return false;
    return true;
}
export function AuthenticatorTOTPChallengeFromJSON(json) {
    return AuthenticatorTOTPChallengeFromJSONTyped(json, false);
}
export function AuthenticatorTOTPChallengeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthenticatorTOTPChallengeToJSON(json) {
    return AuthenticatorTOTPChallengeToJSONTyped(json, false);
}
export function AuthenticatorTOTPChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
