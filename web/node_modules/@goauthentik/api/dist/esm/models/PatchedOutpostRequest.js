 ...
 */
export function instanceOfPatchedOutpostRequest(value) {
    return true;
}
export function PatchedOutpostRequestFromJSON(json) {
    return PatchedOutpostRequestFromJSONTyped(json, false);
}
export function PatchedOutpostRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedOutpostRequestToJSON(json) {
    return PatchedOutpostRequestToJSONTyped(json, false);
}
export function PatchedOutpostRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
