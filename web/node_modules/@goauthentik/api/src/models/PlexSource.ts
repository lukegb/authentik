...
export function PlexSourceToJSONTyped(value?: Omit<PlexSource, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'managed'|'icon'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
