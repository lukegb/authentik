 ...
 */
export function instanceOfLDAPSourceRequest(value: object): boolean {
    let isInstance = true;
...
export function LDAPSourceRequestFromJSON(json: any): LDAPSourceRequest {
...
export function LDAPSourceRequestToJSON(value?: LDAPSourceRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
