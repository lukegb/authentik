 ...
 */
export function instanceOfLDAPSourceRequest(value) {
...
export function LDAPSourceRequestFromJSON(json) {
    return LDAPSourceRequestFromJSONTyped(json, false);
}
export function LDAPSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function LDAPSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
