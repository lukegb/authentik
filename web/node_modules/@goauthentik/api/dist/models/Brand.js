...
exports.BrandToJSONTyped = BrandToJSONTyped;
/**
 * Check if a given object implements the Brand interface.
 */
function instanceOfBrand(value) {
    if (!('brandUuid' in value) || value['brandUuid'] === undefined)
        return false;
...
function BrandToJSON(json) {
    return BrandToJSONTyped(json, false);
}
function BrandToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
