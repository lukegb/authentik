 ...
 */
export function instanceOfTypeCreate(value) {
...
export function TypeCreateFromJSON(json) {
    return TypeCreateFromJSONTyped(json, false);
}
export function TypeCreateFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TypeCreateToJSON(json) {
    return TypeCreateToJSONTyped(json, false);
}
export function TypeCreateToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
