 ...
 */
export function instanceOfPatchedRadiusProviderRequest(value) {
    return true;
}
export function PatchedRadiusProviderRequestFromJSON(json) {
    return PatchedRadiusProviderRequestFromJSONTyped(json, false);
}
export function PatchedRadiusProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedRadiusProviderRequestToJSON(json) {
    return PatchedRadiusProviderRequestToJSONTyped(json, false);
}
export function PatchedRadiusProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
