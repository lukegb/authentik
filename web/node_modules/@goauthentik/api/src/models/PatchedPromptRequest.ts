...
export function PatchedPromptRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedPromptRequest {
    ...
    return {
        ...
        'promptstageSet': json['promptstage_set'] == null ? undefined : ((json['promptstage_set'] as Array<any>).map(StageRequestFromJSON)),
...
export function PatchedPromptRequestToJSONTyped(value?: PatchedPromptRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'order': value['order'],
        'promptstage_set': value['promptstageSet'] == null ? undefined : ((value['promptstageSet'] as Array<any>).map(StageRequestToJSON)),
