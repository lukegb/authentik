...
exports.PaginatedExtraRoleObjectPermissionListToJSONTyped = PaginatedExtraRoleObjectPermissionListToJSONTyped;
...
function PaginatedExtraRoleObjectPermissionListToJSON(json) {
    return PaginatedExtraRoleObjectPermissionListToJSONTyped(json, false);
}
function PaginatedExtraRoleObjectPermissionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
