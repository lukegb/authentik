 ...
 */
export declare function instanceOfIdentificationStageRequest(value: object): value is IdentificationStageRequest;
export declare function IdentificationStageRequestFromJSON(json: any): IdentificationStageRequest;
export declare function IdentificationStageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationStageRequest;
export declare function IdentificationStageRequestToJSON(json: any): IdentificationStageRequest;
export declare function IdentificationStageRequestToJSONTyped(value?: IdentificationStageRequest | null, ignoreDiscriminator?: boolean): any;
