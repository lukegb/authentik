 ...
 */
export declare function instanceOfProxyOutpostConfig(value: object): value is ProxyOutpostConfig;
export declare function ProxyOutpostConfigFromJSON(json: any): ProxyOutpostConfig;
export declare function ProxyOutpostConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProxyOutpostConfig;
export declare function ProxyOutpostConfigToJSON(json: any): ProxyOutpostConfig;
export declare function ProxyOutpostConfigToJSONTyped(value?: Omit<ProxyOutpostConfig, 'pk' | 'oidc_configuration' | 'access_token_validity' | 'scopes_to_request' | 'assigned_application_slug' | 'assigned_application_name'> | null, ignoreDiscriminator?: boolean): any;
