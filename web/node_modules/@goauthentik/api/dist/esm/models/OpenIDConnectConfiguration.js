 ...
 */
export function instanceOfOpenIDConnectConfiguration(value) {
    let isInstance = true;
...
export function OpenIDConnectConfigurationFromJSON(json) {
    return OpenIDConnectConfigurationFromJSONTyped(json, false);
}
export function OpenIDConnectConfigurationFromJSONTyped(json, ignoreDiscriminator) {
...
export function OpenIDConnectConfigurationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
