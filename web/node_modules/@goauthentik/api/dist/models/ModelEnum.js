...
exports.instanceOfModelEnum = instanceOfModelEnum;
...
exports.ModelEnumToJSONTyped = ModelEnumToJSONTyped;
/**
 *
 * @export
 */
...
function instanceOfModelEnum(value) {
    for (const key in exports.ModelEnum) {
        if (Object.prototype.hasOwnProperty.call(exports.ModelEnum, key)) {
            if (exports.ModelEnum[key] === value) {
                return true;
            }
        }
    }
...
function ModelEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
