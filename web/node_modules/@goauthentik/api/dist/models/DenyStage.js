...
exports.DenyStageToJSON = exports.DenyStageFromJSONTyped = exports.DenyStageFromJSON = exports.instanceOfDenyStage = void 0;
const runtime_1 = require("../runtime");
const FlowSet_1 = require("./FlowSet");
/**
 * Check if a given object implements the DenyStage interface.
 */
function instanceOfDenyStage(value) {
    let isInstance = true;
...
exports.instanceOfDenyStage = instanceOfDenyStage;
function DenyStageFromJSON(json) {
    return DenyStageFromJSONTyped(json, false);
}
exports.DenyStageFromJSON = DenyStageFromJSON;
function DenyStageFromJSONTyped(json, ignoreDiscriminator) {
...
function DenyStageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
