 ...
 */
export function instanceOfUserDeleteStageRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function UserDeleteStageRequestFromJSON(json) {
    return UserDeleteStageRequestFromJSONTyped(json, false);
}
export function UserDeleteStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserDeleteStageRequestToJSON(json) {
    return UserDeleteStageRequestToJSONTyped(json, false);
}
export function UserDeleteStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
