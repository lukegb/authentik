 ...
 */
export declare function instanceOfPatchedPlexSourceRequest(value: object): value is PatchedPlexSourceRequest;
export declare function PatchedPlexSourceRequestFromJSON(json: any): PatchedPlexSourceRequest;
export declare function PatchedPlexSourceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedPlexSourceRequest;
export declare function PatchedPlexSourceRequestToJSON(json: any): PatchedPlexSourceRequest;
export declare function PatchedPlexSourceRequestToJSONTyped(value?: PatchedPlexSourceRequest | null, ignoreDiscriminator?: boolean): any;
