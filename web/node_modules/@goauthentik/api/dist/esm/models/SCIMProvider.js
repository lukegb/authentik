 ...
 */
export function instanceOfSCIMProvider(value) {
...
export function SCIMProviderFromJSON(json) {
    return SCIMProviderFromJSONTyped(json, false);
}
export function SCIMProviderFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SCIMProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
