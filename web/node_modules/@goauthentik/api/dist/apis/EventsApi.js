...
class EventsApi extends runtime.BaseAPI {
    ...
    eventsEventsCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.EventRequestToJSON)(requestParameters.eventRequest),
            }, initOverrides);
    ...
    eventsEventsListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedEventListFromJSON)(jsonValue));
        });
    }
    /**
     * Event Read-Only Viewset
    ...
    eventsEventsPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedEventRequestToJSON)(requestParameters.patchedEventRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.EventFromJSON)(jsonValue));
        });
    }
    ...
    eventsEventsTopPerUserListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.EventTopPerUserFromJSON));
        });
    }
    /**
     * Get the top_n events grouped by user count
    ...
    eventsNotificationsListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedNotificationListFromJSON)(jsonValue));
        });
    }
    /**
     * Notification Viewset
    ...
    eventsNotificationsPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedNotificationRequestToJSON)(requestParameters.patchedNotificationRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationFromJSON)(jsonValue));
        });
    }
    /**
     * Notification Viewset
    ...
    eventsNotificationsUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.NotificationRequestToJSON)(requestParameters.notificationRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationFromJSON)(jsonValue));
        });
    }
    ...
    eventsRulesCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.NotificationRuleRequestToJSON)(requestParameters.notificationRuleRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationRuleFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationRule Viewset
    ...
    eventsRulesListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedNotificationRuleListFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationRule Viewset
    ...
    eventsRulesPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedNotificationRuleRequestToJSON)(requestParameters.patchedNotificationRuleRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationRuleFromJSON)(jsonValue));
        });
    }
    ...
    eventsTransportsCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.NotificationTransportRequestToJSON)(requestParameters.notificationTransportRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationTransportFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationTransport Viewset
    ...
    eventsTransportsListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedNotificationTransportListFromJSON)(jsonValue));
        });
    }
    /**
     * NotificationTransport Viewset
    ...
    eventsTransportsPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedNotificationTransportRequestToJSON)(requestParameters.patchedNotificationTransportRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationTransportFromJSON)(jsonValue));
        });
    }
    ...
    eventsTransportsTestCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.NotificationTransportTestFromJSON)(jsonValue));
        });
    }
    /**
     * Send example notification using selected transport. Requires Modify permissions.
