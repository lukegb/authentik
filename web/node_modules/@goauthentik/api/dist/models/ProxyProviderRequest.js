...
exports.instanceOfProxyProviderRequest = instanceOfProxyProviderRequest;
exports.ProxyProviderRequestFromJSON = ProxyProviderRequestFromJSON;
exports.ProxyProviderRequestFromJSONTyped = ProxyProviderRequestFromJSONTyped;
exports.ProxyProviderRequestToJSON = ProxyProviderRequestToJSON;
exports.ProxyProviderRequestToJSONTyped = ProxyProviderRequestToJSONTyped;
const ProxyMode_1 = require("./ProxyMode");
/**
 * Check if a given object implements the ProxyProviderRequest interface.
 */
function instanceOfProxyProviderRequest(value) {
...
function ProxyProviderRequestFromJSON(json) {
    return ProxyProviderRequestFromJSONTyped(json, false);
}
function ProxyProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function ProxyProviderRequestToJSON(json) {
    return ProxyProviderRequestToJSONTyped(json, false);
}
function ProxyProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
