 ...
 */
export function instanceOfSCIMMapping(value) {
...
export function SCIMMappingFromJSON(json) {
    return SCIMMappingFromJSONTyped(json, false);
}
export function SCIMMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SCIMMappingToJSON(json) {
    return SCIMMappingToJSONTyped(json, false);
}
export function SCIMMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
