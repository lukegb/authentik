...
// checks if the PatchedGroupKerberosSourceConnectionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedGroupKerberosSourceConnectionRequest{}
...
func (o PatchedGroupKerberosSourceConnectionRequest) ToMap() (map[string]interface{}, error) {
