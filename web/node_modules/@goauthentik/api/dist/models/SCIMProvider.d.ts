 ...
 */
export declare function instanceOfSCIMProvider(value: object): value is SCIMProvider;
...
export declare function SCIMProviderToJSON(json: any): SCIMProvider;
export declare function SCIMProviderToJSONTyped(value?: Omit<SCIMProvider, 'pk' | 'component' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
