...
// checks if the KerberosSourcePropertyMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosSourcePropertyMapping{}
...
func (o KerberosSourcePropertyMapping) ToMap() (map[string]interface{}, error) {
