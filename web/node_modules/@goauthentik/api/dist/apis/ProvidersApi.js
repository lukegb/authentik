...
class ProvidersApi extends runtime.BaseAPI {
    ...
    providersAllListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedProviderListFromJSON)(jsonValue));
        });
    }
    /**
     * Provider Viewset
    ...
    providersOauth2CreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.OAuth2ProviderRequestToJSON)(requestParameters.oAuth2ProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OAuth2ProviderFromJSON)(jsonValue));
        });
    }
    /**
     * OAuth2Provider Viewset
    ...
    providersOauth2ListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedOAuth2ProviderListFromJSON)(jsonValue));
        });
    }
    /**
     * OAuth2Provider Viewset
    ...
    providersOauth2PartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedOAuth2ProviderRequestToJSON)(requestParameters.patchedOAuth2ProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OAuth2ProviderFromJSON)(jsonValue));
        });
    }
    ...
    providersOauth2PreviewUserRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PropertyMappingPreviewFromJSON)(jsonValue));
        });
    }
    /**
     * Preview user data for provider
    ...
    providersOauth2SetupUrlsRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OAuth2ProviderSetupURLsFromJSON)(jsonValue));
        });
    }
    /**
     * Get Providers setup URLs
    ...
    providersProxyCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ProxyProviderRequestToJSON)(requestParameters.proxyProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ProxyProviderFromJSON)(jsonValue));
        });
    }
    /**
     * ProxyProvider Viewset
    ...
    providersProxyListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedProxyProviderListFromJSON)(jsonValue));
        });
    }
    /**
     * ProxyProvider Viewset
    ...
    providersProxyPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedProxyProviderRequestToJSON)(requestParameters.patchedProxyProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ProxyProviderFromJSON)(jsonValue));
        });
    }
    ...
    providersSamlCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.SAMLProviderRequestToJSON)(requestParameters.sAMLProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SAMLProviderFromJSON)(jsonValue));
        });
    }
    /**
     * SAMLProvider Viewset
    ...
    providersSamlListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedSAMLProviderListFromJSON)(jsonValue));
        });
    }
    /**
     * SAMLProvider Viewset
    ...
    providersSamlPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedSAMLProviderRequestToJSON)(requestParameters.patchedSAMLProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SAMLProviderFromJSON)(jsonValue));
        });
    }
    ...
    providersScimCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.SCIMProviderRequestToJSON)(requestParameters.sCIMProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SCIMProviderFromJSON)(jsonValue));
        });
    }
    /**
     * SCIMProvider Viewset
    ...
    providersScimListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedSCIMProviderListFromJSON)(jsonValue));
        });
    }
    /**
     * SCIMProvider Viewset
    ...
    providersScimPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedSCIMProviderRequestToJSON)(requestParameters.patchedSCIMProviderRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SCIMProviderFromJSON)(jsonValue));
        });
    }
