 ...
 */
export function instanceOfRadiusProvider(value) {
...
export function RadiusProviderFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RadiusProviderToJSON(json) {
    return RadiusProviderToJSONTyped(json, false);
}
export function RadiusProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
