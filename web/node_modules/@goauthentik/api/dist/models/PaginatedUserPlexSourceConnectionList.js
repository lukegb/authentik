...
exports.PaginatedUserPlexSourceConnectionListToJSONTyped = PaginatedUserPlexSourceConnectionListToJSONTyped;
...
function PaginatedUserPlexSourceConnectionListToJSON(json) {
    return PaginatedUserPlexSourceConnectionListToJSONTyped(json, false);
}
function PaginatedUserPlexSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
