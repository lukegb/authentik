 ...
 */
export function instanceOfOAuthSourceRequest(value) {
    ...
    if (!('providerType' in value) || value['providerType'] === undefined)
        return false;
    if (!('consumerKey' in value) || value['consumerKey'] === undefined)
        return false;
    if (!('consumerSecret' in value) || value['consumerSecret'] === undefined)
        return false;
    return true;
}
export function OAuthSourceRequestFromJSON(json) {
    return OAuthSourceRequestFromJSONTyped(json, false);
}
export function OAuthSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function OAuthSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
