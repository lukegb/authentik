...
// checks if the PaginatedSystemTaskList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedSystemTaskList{}
...
func (o PaginatedSystemTaskList) ToMap() (map[string]interface{}, error) {
