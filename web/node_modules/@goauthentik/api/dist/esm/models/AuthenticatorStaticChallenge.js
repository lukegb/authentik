...
export function AuthenticatorStaticChallengeFromJSON(json) {
    return AuthenticatorStaticChallengeFromJSONTyped(json, false);
}
export function AuthenticatorStaticChallengeFromJSONTyped(json, ignoreDiscriminator) {
...
export function AuthenticatorStaticChallengeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
