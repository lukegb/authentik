...
exports.PaginatedMicrosoftEntraProviderListToJSONTyped = PaginatedMicrosoftEntraProviderListToJSONTyped;
...
function PaginatedMicrosoftEntraProviderListToJSON(json) {
    return PaginatedMicrosoftEntraProviderListToJSONTyped(json, false);
}
function PaginatedMicrosoftEntraProviderListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
