 ...
 */
export function instanceOfAuthenticatorDuoStage(value) {
...
export function AuthenticatorDuoStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthenticatorDuoStageToJSON(json) {
    return AuthenticatorDuoStageToJSONTyped(json, false);
}
export function AuthenticatorDuoStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
