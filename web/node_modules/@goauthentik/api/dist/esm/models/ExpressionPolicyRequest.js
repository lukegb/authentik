 ...
 */
export function instanceOfExpressionPolicyRequest(value) {
...
export function ExpressionPolicyRequestFromJSON(json) {
    return ExpressionPolicyRequestFromJSONTyped(json, false);
}
export function ExpressionPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ExpressionPolicyRequestToJSON(json) {
    return ExpressionPolicyRequestToJSONTyped(json, false);
}
export function ExpressionPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
