 ...
 */
export function instanceOfPatchedIdentificationStageRequest(value) {
    return true;
}
export function PatchedIdentificationStageRequestFromJSON(json) {
    return PatchedIdentificationStageRequestFromJSONTyped(json, false);
}
export function PatchedIdentificationStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'userFields': json['user_fields'] == null ? undefined : (json['user_fields'].map(UserFieldsEnumFromJSON)),
...
export function PatchedIdentificationStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'user_fields': value['userFields'] == null ? undefined : (value['userFields'].map(UserFieldsEnumToJSON)),
