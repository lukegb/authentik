 ...
 */
export declare function instanceOfAuthenticatorSMSStage(value: object): value is AuthenticatorSMSStage;
...
export declare function AuthenticatorSMSStageToJSON(json: any): AuthenticatorSMSStage;
export declare function AuthenticatorSMSStageToJSONTyped(value?: Omit<AuthenticatorSMSStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
