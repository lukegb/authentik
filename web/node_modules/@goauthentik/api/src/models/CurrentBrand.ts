...
export function CurrentBrandToJSONTyped(value?: Omit<CurrentBrand, 'ui_footer_links'|'ui_theme'|'default_locale'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
