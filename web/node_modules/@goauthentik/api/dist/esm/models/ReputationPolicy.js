 ...
 */
export function instanceOfReputationPolicy(value) {
    let isInstance = true;
...
export function ReputationPolicyFromJSON(json) {
    return ReputationPolicyFromJSONTyped(json, false);
}
export function ReputationPolicyFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReputationPolicyToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
