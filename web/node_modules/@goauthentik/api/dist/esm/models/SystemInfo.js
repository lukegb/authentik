...
export function instanceOfSystemInfo(value) {
    if (!('httpHeaders' in value) || value['httpHeaders'] === undefined)
        return false;
    if (!('httpHost' in value) || value['httpHost'] === undefined)
        return false;
    if (!('httpIsSecure' in value) || value['httpIsSecure'] === undefined)
        return false;
...
export function SystemInfoToJSON(json) {
    return SystemInfoToJSONTyped(json, false);
}
export function SystemInfoToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
