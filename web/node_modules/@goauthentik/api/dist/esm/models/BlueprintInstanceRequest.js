 ...
 */
export function instanceOfBlueprintInstanceRequest(value) {
...
export function BlueprintInstanceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function BlueprintInstanceRequestToJSON(json) {
    return BlueprintInstanceRequestToJSONTyped(json, false);
}
export function BlueprintInstanceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
