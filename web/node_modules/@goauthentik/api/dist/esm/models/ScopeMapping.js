 ...
 */
export function instanceOfScopeMapping(value) {
    ...
    if (!('metaModelName' in value) || value['metaModelName'] === undefined)
        return false;
    if (!('scopeName' in value) || value['scopeName'] === undefined)
        return false;
    return true;
}
export function ScopeMappingFromJSON(json) {
    return ScopeMappingFromJSONTyped(json, false);
}
export function ScopeMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ScopeMappingToJSON(json) {
    return ScopeMappingToJSONTyped(json, false);
}
export function ScopeMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
