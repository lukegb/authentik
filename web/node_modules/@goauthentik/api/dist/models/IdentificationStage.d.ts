 ...
 */
export declare function instanceOfIdentificationStage(value: object): value is IdentificationStage;
export declare function IdentificationStageFromJSON(json: any): IdentificationStage;
export declare function IdentificationStageFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationStage;
export declare function IdentificationStageToJSON(json: any): IdentificationStage;
export declare function IdentificationStageToJSONTyped(value?: Omit<IdentificationStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
