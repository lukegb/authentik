 ...
 */
export declare function instanceOfCertificateKeyPair(value: object): value is CertificateKeyPair;
...
export declare function CertificateKeyPairToJSON(json: any): CertificateKeyPair;
export declare function CertificateKeyPairToJSONTyped(value?: Omit<CertificateKeyPair, 'pk' | 'fingerprint_sha256' | 'fingerprint_sha1' | 'cert_expiry' | 'cert_subject' | 'private_key_available' | 'private_key_type' | 'certificate_download_url' | 'private_key_download_url' | 'managed'> | null, ignoreDiscriminator?: boolean): any;
