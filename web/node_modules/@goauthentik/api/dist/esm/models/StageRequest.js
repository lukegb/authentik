 ...
 */
export function instanceOfStageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    return isInstance;
}
export function StageRequestFromJSON(json) {
    return StageRequestFromJSONTyped(json, false);
}
export function StageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function StageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
