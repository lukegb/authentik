...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.StagesApi.StagesAuthenticatorEmailDestroy(context.Background(), stageUuid).Execute()
    if err != nil {
...
> ExtAuthStage StagesExtAuthCreate(ctx).ExtAuthStageRequest(extAuthStageRequest).Execute()
...
func main() {
    extAuthStageRequest := *openapiclient.NewExtAuthStageRequest("Name_example") // ExtAuthStageRequest | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthCreate(context.Background()).ExtAuthStageRequest(extAuthStageRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthCreate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthCreate`: ExtAuthStage
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **extAuthStageRequest** | [**ExtAuthStageRequest**](ExtAuthStageRequest.md) |  | 

### Return type

[**ExtAuthStage**](ExtAuthStage.md)
...
## StagesExtAuthDestroy

> StagesExtAuthDestroy(ctx, stageUuid).Execute()
...
func main() {
    stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this ExtAuth Stage.

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.StagesApi.StagesExtAuthDestroy(context.Background(), stageUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthDestroy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**stageUuid** | **string** | A UUID string identifying this ExtAuth Stage. | 

### Other Parameters

Other parameters are passed through a pointer to a apiStagesExtAuthDestroyRequest struct via the builder pattern
...
> PaginatedExtAuthStageList StagesExtAuthList(ctx).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).StageUuid(stageUuid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthList(context.Background()).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).StageUuid(stageUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthList`: PaginatedExtAuthStageList
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthListRequest struct via the builder pattern
...
[**PaginatedExtAuthStageList**](PaginatedExtAuthStageList.md)
...
## StagesExtAuthPartialUpdate

> ExtAuthStage StagesExtAuthPartialUpdate(ctx, stageUuid).PatchedExtAuthStageRequest(patchedExtAuthStageRequest).Execute()
...
func main() {
    stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this ExtAuth Stage.
    patchedExtAuthStageRequest := *openapiclient.NewPatchedExtAuthStageRequest() // PatchedExtAuthStageRequest |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthPartialUpdate(context.Background(), stageUuid).PatchedExtAuthStageRequest(patchedExtAuthStageRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthPartialUpdate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthPartialUpdate`: ExtAuthStage
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedExtAuthStageRequest** | [**PatchedExtAuthStageRequest**](PatchedExtAuthStageRequest.md) |  | 
...
## StagesExtAuthRetrieve

> ExtAuthStage StagesExtAuthRetrieve(ctx, stageUuid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthRetrieve(context.Background(), stageUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthRetrieve``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthRetrieve`: ExtAuthStage
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthRetrieveRequest struct via the builder pattern
...
> ExtAuthStage StagesExtAuthUpdate(ctx, stageUuid).ExtAuthStageRequest(extAuthStageRequest).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthUpdate(context.Background(), stageUuid).ExtAuthStageRequest(extAuthStageRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthUpdate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthUpdate`: ExtAuthStage
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthUpdateRequest struct via the builder pattern
...
## StagesExtAuthUsedByList

> []UsedBy StagesExtAuthUsedByList(ctx, stageUuid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.StagesApi.StagesExtAuthUsedByList(context.Background(), stageUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `StagesApi.StagesExtAuthUsedByList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `StagesExtAuthUsedByList`: []UsedBy
    fmt.Fprintf(os.Stdout, "Response from `StagesApi.StagesExtAuthUsedByList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesExtAuthUsedByListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.StagesApi.StagesRedirectDestroy(context.Background(), stageUuid).Execute()
    if err != nil {
