 ...
 */
export function instanceOfAuthenticatorStaticStageRequest(value) {
...
export function AuthenticatorStaticStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthenticatorStaticStageRequestToJSON(json) {
    return AuthenticatorStaticStageRequestToJSONTyped(json, false);
}
export function AuthenticatorStaticStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
