...
func Test_api_OutpostsApiService(t *testing.T) {
	...
	t.Run("Test OutpostsApiService OutpostsLdapAccessCheck", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.OutpostsApi.OutpostsLdapAccessCheck(context.Background(), id).Execute()
	...
	t.Run("Test OutpostsApiService OutpostsRadiusAccessCheck", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.OutpostsApi.OutpostsRadiusAccessCheck(context.Background(), id).Execute()
