...
export function UserOAuthSourceConnectionRequestFromJSON(json) {
    return UserOAuthSourceConnectionRequestFromJSONTyped(json, false);
}
export function UserOAuthSourceConnectionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UserOAuthSourceConnectionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
