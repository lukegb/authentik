...
exports.MicrosoftEntraProviderGroupToJSONTyped = MicrosoftEntraProviderGroupToJSONTyped;
...
function instanceOfMicrosoftEntraProviderGroup(value) {
    if (!('id' in value) || value['id'] === undefined)
        return false;
    if (!('microsoftId' in value) || value['microsoftId'] === undefined)
        return false;
    if (!('group' in value) || value['group'] === undefined)
        return false;
    if (!('groupObj' in value) || value['groupObj'] === undefined)
        return false;
...
function MicrosoftEntraProviderGroupToJSON(json) {
    return MicrosoftEntraProviderGroupToJSONTyped(json, false);
}
function MicrosoftEntraProviderGroupToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
