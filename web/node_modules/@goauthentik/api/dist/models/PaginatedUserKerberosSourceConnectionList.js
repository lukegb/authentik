...
exports.PaginatedUserKerberosSourceConnectionListToJSONTyped = PaginatedUserKerberosSourceConnectionListToJSONTyped;
...
function PaginatedUserKerberosSourceConnectionListToJSON(json) {
    return PaginatedUserKerberosSourceConnectionListToJSONTyped(json, false);
}
function PaginatedUserKerberosSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
