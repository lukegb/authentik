...
// checks if the OAuthSourcePropertyMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthSourcePropertyMapping{}
...
func NewOAuthSourcePropertyMapping(pk string, name string, expression string, component string, verboseName string, verboseNamePlural string, metaModelName string) *OAuthSourcePropertyMapping {
	this := OAuthSourcePropertyMapping{}
	this.Pk = pk
	this.Name = name
...
func (o *OAuthSourcePropertyMapping) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o OAuthSourcePropertyMapping) MarshalJSON() ([]byte, error) {
...
func (o OAuthSourcePropertyMapping) ToMap() (map[string]interface{}, error) {
...
type NullableOAuthSourcePropertyMapping struct {
	value *OAuthSourcePropertyMapping
	isSet bool
}

func (v NullableOAuthSourcePropertyMapping) Get() *OAuthSourcePropertyMapping {
	return v.value
}

func (v *NullableOAuthSourcePropertyMapping) Set(val *OAuthSourcePropertyMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthSourcePropertyMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthSourcePropertyMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthSourcePropertyMapping(val *OAuthSourcePropertyMapping) *NullableOAuthSourcePropertyMapping {
	return &NullableOAuthSourcePropertyMapping{value: val, isSet: true}
}

func (v NullableOAuthSourcePropertyMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthSourcePropertyMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
