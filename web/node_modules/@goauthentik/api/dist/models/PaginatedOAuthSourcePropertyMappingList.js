...
exports.PaginatedOAuthSourcePropertyMappingListToJSONTyped = PaginatedOAuthSourcePropertyMappingListToJSONTyped;
...
function PaginatedOAuthSourcePropertyMappingListToJSON(json) {
    return PaginatedOAuthSourcePropertyMappingListToJSONTyped(json, false);
}
function PaginatedOAuthSourcePropertyMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
