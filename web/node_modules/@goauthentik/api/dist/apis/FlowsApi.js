...
class FlowsApi extends runtime.BaseAPI {
    ...
    flowsBindingsCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.FlowStageBindingRequestToJSON)(requestParameters.flowStageBindingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowStageBindingFromJSON)(jsonValue));
        });
    }
    /**
     * FlowStageBinding Viewset
    ...
    flowsBindingsListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedFlowStageBindingListFromJSON)(jsonValue));
        });
    }
    /**
     * FlowStageBinding Viewset
    ...
    flowsBindingsPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedFlowStageBindingRequestToJSON)(requestParameters.patchedFlowStageBindingRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowStageBindingFromJSON)(jsonValue));
        });
    }
    ...
    flowsExecutorGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ChallengeTypesFromJSON)(jsonValue));
        });
    }
    /**
     * Get the next pending challenge from the currently active flow.
    ...
    flowsExecutorSolveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.FlowChallengeResponseRequestToJSON)(requestParameters.flowChallengeResponseRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ChallengeTypesFromJSON)(jsonValue));
        });
    }
    ...
    flowsInspectorGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowInspectionFromJSON)(jsonValue));
        });
    }
    /**
     * Get current flow state and record it
    ...
    flowsInstancesCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.FlowRequestToJSON)(requestParameters.flowRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowFromJSON)(jsonValue));
        });
    }
    /**
     * Flow Viewset
    ...
    flowsInstancesDiagramRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowDiagramFromJSON)(jsonValue));
        });
    }
    /**
     * Return diagram for flow with slug `slug`, in the format used by flowchart.js
    ...
    flowsInstancesListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedFlowListFromJSON)(jsonValue));
        });
    }
    /**
     * Flow Viewset
    ...
    flowsInstancesPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedFlowRequestToJSON)(requestParameters.patchedFlowRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.FlowFromJSON)(jsonValue));
        });
    }
