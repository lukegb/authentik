 ...
 */
export function instanceOfPolicyRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function PolicyRequestFromJSON(json) {
    return PolicyRequestFromJSONTyped(json, false);
}
export function PolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PolicyRequestToJSON(json) {
    return PolicyRequestToJSONTyped(json, false);
}
export function PolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
