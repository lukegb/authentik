 ...
 */
export declare function instanceOfSAMLProvider(value: object): value is SAMLProvider;
...
export declare function SAMLProviderToJSON(json: any): SAMLProvider;
export declare function SAMLProviderToJSONTyped(value?: Omit<SAMLProvider, 'pk' | 'component' | 'assigned_application_slug' | 'assigned_application_name' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'url_download_metadata' | 'url_sso_post' | 'url_sso_redirect' | 'url_sso_init' | 'url_slo_post' | 'url_slo_redirect'> | null, ignoreDiscriminator?: boolean): any;
