 ...
 */
export declare function instanceOfPasswordStage(value: object): value is PasswordStage;
...
export declare function PasswordStageToJSON(json: any): PasswordStage;
export declare function PasswordStageToJSONTyped(value?: Omit<PasswordStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
