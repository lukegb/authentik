...
// checks if the PatchedPlexSourcePropertyMappingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedPlexSourcePropertyMappingRequest{}
...
func NewPatchedPlexSourcePropertyMappingRequest() *PatchedPlexSourcePropertyMappingRequest {
	this := PatchedPlexSourcePropertyMappingRequest{}
	return &this
}
...
func (o *PatchedPlexSourcePropertyMappingRequest) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o PatchedPlexSourcePropertyMappingRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedPlexSourcePropertyMappingRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedPlexSourcePropertyMappingRequest struct {
	value *PatchedPlexSourcePropertyMappingRequest
	isSet bool
}

func (v NullablePatchedPlexSourcePropertyMappingRequest) Get() *PatchedPlexSourcePropertyMappingRequest {
	return v.value
}

func (v *NullablePatchedPlexSourcePropertyMappingRequest) Set(val *PatchedPlexSourcePropertyMappingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedPlexSourcePropertyMappingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedPlexSourcePropertyMappingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedPlexSourcePropertyMappingRequest(val *PatchedPlexSourcePropertyMappingRequest) *NullablePatchedPlexSourcePropertyMappingRequest {
	return &NullablePatchedPlexSourcePropertyMappingRequest{value: val, isSet: true}
}

func (v NullablePatchedPlexSourcePropertyMappingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedPlexSourcePropertyMappingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
