 ...
 */
export function instanceOfPlexSourceRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('slug' in value) || value['slug'] === undefined)
        return false;
    if (!('plexToken' in value) || value['plexToken'] === undefined)
        return false;
    return true;
}
export function PlexSourceRequestFromJSON(json) {
    return PlexSourceRequestFromJSONTyped(json, false);
}
export function PlexSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PlexSourceRequestToJSON(json) {
    return PlexSourceRequestToJSONTyped(json, false);
}
export function PlexSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
