 ...
 */
export function instanceOfSAMLPropertyMapping(value) {
    ...
    if (!('metaModelName' in value) || value['metaModelName'] === undefined)
        return false;
    if (!('samlName' in value) || value['samlName'] === undefined)
        return false;
    return true;
}
export function SAMLPropertyMappingFromJSON(json) {
    return SAMLPropertyMappingFromJSONTyped(json, false);
}
export function SAMLPropertyMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SAMLPropertyMappingToJSON(json) {
    return SAMLPropertyMappingToJSONTyped(json, false);
}
export function SAMLPropertyMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
