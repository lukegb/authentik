...
func (a *SsfApiService) SsfStreamsListExecute(r ApiSsfStreamsListRequest) (*PaginatedSSFStreamList, *http.Response, error) {
	...
	if r.deliveryMethod != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "delivery_method", r.deliveryMethod, "")
	}
	if r.endpointUrl != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "endpoint_url", r.endpointUrl, "")
	}
	if r.ordering != nil {
