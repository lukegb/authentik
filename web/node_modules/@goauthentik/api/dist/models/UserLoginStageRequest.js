 ...
 */
function instanceOfUserLoginStageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    return isInstance;
}
exports.instanceOfUserLoginStageRequest = instanceOfUserLoginStageRequest;
function UserLoginStageRequestFromJSON(json) {
    return UserLoginStageRequestFromJSONTyped(json, false);
}
exports.UserLoginStageRequestFromJSON = UserLoginStageRequestFromJSON;
function UserLoginStageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
function UserLoginStageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
