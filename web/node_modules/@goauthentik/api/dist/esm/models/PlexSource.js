 ...
 */
export function instanceOfPlexSource(value) {
...
export function PlexSourceFromJSON(json) {
    return PlexSourceFromJSONTyped(json, false);
}
export function PlexSourceFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PlexSourceToJSON(json) {
    return PlexSourceToJSONTyped(json, false);
}
export function PlexSourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
