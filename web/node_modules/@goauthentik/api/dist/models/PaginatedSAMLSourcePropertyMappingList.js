...
exports.PaginatedSAMLSourcePropertyMappingListToJSONTyped = PaginatedSAMLSourcePropertyMappingListToJSONTyped;
...
function PaginatedSAMLSourcePropertyMappingListToJSON(json) {
    return PaginatedSAMLSourcePropertyMappingListToJSONTyped(json, false);
}
function PaginatedSAMLSourcePropertyMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
