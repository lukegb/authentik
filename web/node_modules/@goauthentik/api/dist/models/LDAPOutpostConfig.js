...
exports.instanceOfLDAPOutpostConfig = instanceOfLDAPOutpostConfig;
exports.LDAPOutpostConfigFromJSON = LDAPOutpostConfigFromJSON;
...
exports.LDAPOutpostConfigToJSONTyped = LDAPOutpostConfigToJSONTyped;
const LDAPAPIAccessMode_1 = require("./LDAPAPIAccessMode");
/**
 * Check if a given object implements the LDAPOutpostConfig interface.
 */
function instanceOfLDAPOutpostConfig(value) {
    if (!('pk' in value) || value['pk'] === undefined)
        return false;
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('bindFlowSlug' in value) || value['bindFlowSlug'] === undefined)
        return false;
    if (!('unbindFlowSlug' in value) || value['unbindFlowSlug'] === undefined)
        return false;
    if (!('applicationSlug' in value) || value['applicationSlug'] === undefined)
        return false;
    return true;
}
...
function LDAPOutpostConfigFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'searchMode': json['search_mode'] == null ? undefined : (0, LDAPAPIAccessMode_1.LDAPAPIAccessModeFromJSON)(json['search_mode']),
        'bindMode': json['bind_mode'] == null ? undefined : (0, LDAPAPIAccessMode_1.LDAPAPIAccessModeFromJSON)(json['bind_mode']),
        'mfaSupport': json['mfa_support'] == null ? undefined : json['mfa_support'],
    };
}
function LDAPOutpostConfigToJSON(json) {
    return LDAPOutpostConfigToJSONTyped(json, false);
}
function LDAPOutpostConfigToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
