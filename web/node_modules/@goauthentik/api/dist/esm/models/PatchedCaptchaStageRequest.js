 ...
 */
export function instanceOfPatchedCaptchaStageRequest(value) {
    return true;
}
export function PatchedCaptchaStageRequestFromJSON(json) {
    return PatchedCaptchaStageRequestFromJSONTyped(json, false);
}
export function PatchedCaptchaStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedCaptchaStageRequestToJSON(json) {
    return PatchedCaptchaStageRequestToJSONTyped(json, false);
}
export function PatchedCaptchaStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
