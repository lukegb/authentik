 ...
 */
export function instanceOfProxyProvider(value) {
    ...
    if (!('redirectUris' in value) || value['redirectUris'] === undefined)
        return false;
    if (!('outpostSet' in value) || value['outpostSet'] === undefined)
        return false;
    return true;
}
export function ProxyProviderFromJSON(json) {
    return ProxyProviderFromJSONTyped(json, false);
}
export function ProxyProviderFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ProxyProviderToJSON(json) {
    return ProxyProviderToJSONTyped(json, false);
}
export function ProxyProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
