...
exports.MicrosoftEntraProviderMappingToJSONTyped = MicrosoftEntraProviderMappingToJSONTyped;
/**
...
function MicrosoftEntraProviderMappingToJSON(json) {
    return MicrosoftEntraProviderMappingToJSONTyped(json, false);
}
function MicrosoftEntraProviderMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
