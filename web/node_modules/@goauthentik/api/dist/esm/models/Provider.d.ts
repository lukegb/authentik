 ...
 */
export declare function instanceOfProvider(value: object): value is Provider;
...
export declare function ProviderToJSON(json: any): Provider;
export declare function ProviderToJSONTyped(value?: Omit<Provider, 'pk' | 'component' | 'assigned_application_slug' | 'assigned_application_name' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
