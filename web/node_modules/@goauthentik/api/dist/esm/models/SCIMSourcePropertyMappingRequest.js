...
export function SCIMSourcePropertyMappingRequestToJSON(json) {
    return SCIMSourcePropertyMappingRequestToJSONTyped(json, false);
}
export function SCIMSourcePropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
