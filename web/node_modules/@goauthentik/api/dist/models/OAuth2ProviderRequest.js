...
exports.OAuth2ProviderRequestToJSON = exports.OAuth2ProviderRequestFromJSONTyped = exports.OAuth2ProviderRequestFromJSON = exports.instanceOfOAuth2ProviderRequest = void 0;
 ...
 */
function instanceOfOAuth2ProviderRequest(value) {
    let isInstance = true;
...
function OAuth2ProviderRequestFromJSON(json) {
    return OAuth2ProviderRequestFromJSONTyped(json, false);
}
exports.OAuth2ProviderRequestFromJSON = OAuth2ProviderRequestFromJSON;
function OAuth2ProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'accessCodeValidity': !(0, runtime_1.exists)(json, 'access_code_validity') ? undefined : json['access_code_validity'],
...
function OAuth2ProviderRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
