...
exports.instanceOfSAMLProviderRequest = instanceOfSAMLProviderRequest;
exports.SAMLProviderRequestFromJSON = SAMLProviderRequestFromJSON;
...
exports.SAMLProviderRequestToJSONTyped = SAMLProviderRequestToJSONTyped;
 ...
 */
function instanceOfSAMLProviderRequest(value) {
...
function SAMLProviderRequestFromJSON(json) {
    return SAMLProviderRequestFromJSONTyped(json, false);
}
function SAMLProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SAMLProviderRequestToJSON(json) {
    return SAMLProviderRequestToJSONTyped(json, false);
}
function SAMLProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
