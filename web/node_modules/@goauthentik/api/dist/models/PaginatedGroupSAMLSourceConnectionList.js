...
exports.PaginatedGroupSAMLSourceConnectionListToJSONTyped = PaginatedGroupSAMLSourceConnectionListToJSONTyped;
...
function PaginatedGroupSAMLSourceConnectionListToJSON(json) {
    return PaginatedGroupSAMLSourceConnectionListToJSONTyped(json, false);
}
function PaginatedGroupSAMLSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
