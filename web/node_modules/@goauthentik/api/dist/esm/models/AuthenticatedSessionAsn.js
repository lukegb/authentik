...
export function instanceOfAuthenticatedSessionAsn(value) {
    if (!('asn' in value) || value['asn'] === undefined)
        return false;
    if (!('asOrg' in value) || value['asOrg'] === undefined)
        return false;
...
export function AuthenticatedSessionAsnToJSON(json) {
    return AuthenticatedSessionAsnToJSONTyped(json, false);
}
export function AuthenticatedSessionAsnToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
