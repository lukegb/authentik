 ...
 */
export function instanceOfUserLogoutStage(value) {
...
export function UserLogoutStageFromJSON(json) {
    return UserLogoutStageFromJSONTyped(json, false);
}
export function UserLogoutStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserLogoutStageToJSON(json) {
    return UserLogoutStageToJSONTyped(json, false);
}
export function UserLogoutStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
