...
exports.RoleObjectPermissionToJSONTyped = RoleObjectPermissionToJSONTyped;
/**
...
function RoleObjectPermissionToJSON(json) {
    return RoleObjectPermissionToJSONTyped(json, false);
}
function RoleObjectPermissionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
