 ...
 */
import { StageRequestFromJSON, StageRequestToJSON, } from './StageRequest';
 ...
 */
export function instanceOfPromptRequest(value) {
...
export function PromptRequestFromJSON(json) {
    return PromptRequestFromJSONTyped(json, false);
}
export function PromptRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'promptstageSet': json['promptstage_set'] == null ? undefined : (json['promptstage_set'].map(StageRequestFromJSON)),
...
export function PromptRequestToJSON(json) {
    return PromptRequestToJSONTyped(json, false);
}
export function PromptRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'order': value['order'],
        'promptstage_set': value['promptstageSet'] == null ? undefined : (value['promptstageSet'].map(StageRequestToJSON)),
