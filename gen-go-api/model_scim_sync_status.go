...
// checks if the SCIMSyncStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCIMSyncStatus{}
...
func (o SCIMSyncStatus) ToMap() (map[string]interface{}, error) {
