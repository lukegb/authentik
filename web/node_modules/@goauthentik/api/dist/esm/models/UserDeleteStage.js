 ...
 */
export function instanceOfUserDeleteStage(value) {
...
export function UserDeleteStageFromJSON(json) {
    return UserDeleteStageFromJSONTyped(json, false);
}
export function UserDeleteStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserDeleteStageToJSON(json) {
    return UserDeleteStageToJSONTyped(json, false);
}
export function UserDeleteStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
