...
exports.instanceOfUserLoginChallenge = instanceOfUserLoginChallenge;
...
exports.UserLoginChallengeToJSONTyped = UserLoginChallengeToJSONTyped;
...
function UserLoginChallengeToJSON(json) {
    return UserLoginChallengeToJSONTyped(json, false);
}
function UserLoginChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
