...
// checks if the ExtAuthStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtAuthStage{}

// ExtAuthStage ExtAuthStage Serializer
type ExtAuthStage struct {
	Pk string `json:"pk"`
...
func (o ExtAuthStage) MarshalJSON() ([]byte, error) {
...
func (o ExtAuthStage) ToMap() (map[string]interface{}, error) {
...
type NullableExtAuthStage struct {
	value *ExtAuthStage
	isSet bool
}

func (v NullableExtAuthStage) Get() *ExtAuthStage {
	return v.value
}

func (v *NullableExtAuthStage) Set(val *ExtAuthStage) {
	v.value = val
	v.isSet = true
}

func (v NullableExtAuthStage) IsSet() bool {
	return v.isSet
}

func (v *NullableExtAuthStage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtAuthStage(val *ExtAuthStage) *NullableExtAuthStage {
	return &NullableExtAuthStage{value: val, isSet: true}
}

func (v NullableExtAuthStage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtAuthStage) UnmarshalJSON(src []byte) error {
	v.isSet = true
