...
export function PatchedRadiusProviderPropertyMappingRequestToJSON(json) {
    return PatchedRadiusProviderPropertyMappingRequestToJSONTyped(json, false);
}
export function PatchedRadiusProviderPropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
