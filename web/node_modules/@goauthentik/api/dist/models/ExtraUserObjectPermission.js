...
exports.ExtraUserObjectPermissionToJSONTyped = ExtraUserObjectPermissionToJSONTyped;
/**
...
function instanceOfExtraUserObjectPermission(value) {
    ...
    if (!('model' in value) || value['model'] === undefined)
        return false;
    if (!('appLabel' in value) || value['appLabel'] === undefined)
        return false;
    if (!('objectPk' in value) || value['objectPk'] === undefined)
        return false;
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('appLabelVerbose' in value) || value['appLabelVerbose'] === undefined)
        return false;
    if (!('modelVerbose' in value) || value['modelVerbose'] === undefined)
        return false;
    if (!('objectDescription' in value) || value['objectDescription'] === undefined)
        return false;
    return true;
}
...
function ExtraUserObjectPermissionToJSON(json) {
    return ExtraUserObjectPermissionToJSONTyped(json, false);
}
function ExtraUserObjectPermissionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
