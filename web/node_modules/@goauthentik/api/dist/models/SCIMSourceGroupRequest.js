...
exports.SCIMSourceGroupRequestToJSONTyped = SCIMSourceGroupRequestToJSONTyped;
/**
...
function SCIMSourceGroupRequestToJSON(json) {
    return SCIMSourceGroupRequestToJSONTyped(json, false);
}
function SCIMSourceGroupRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
