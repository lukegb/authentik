...
export function SignatureAlgorithmEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function SignatureAlgorithmEnumToJSON(value) {
    return value;
}
export function SignatureAlgorithmEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
