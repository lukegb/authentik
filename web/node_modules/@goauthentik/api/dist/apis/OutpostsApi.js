...
class OutpostsApi extends runtime.BaseAPI {
    ...
    outpostsInstancesCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.OutpostRequestToJSON)(requestParameters.outpostRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OutpostFromJSON)(jsonValue));
        });
    }
    /**
     * Outpost Viewset
    ...
    outpostsInstancesDefaultSettingsRetrieveRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OutpostDefaultConfigFromJSON)(jsonValue));
        });
    }
    /**
     * Global default outpost config
    ...
    outpostsInstancesHealthListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.OutpostHealthFromJSON));
        });
    }
    /**
     * Get outposts current health
    ...
    outpostsInstancesListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedOutpostListFromJSON)(jsonValue));
        });
    }
    /**
     * Outpost Viewset
    ...
    outpostsInstancesPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedOutpostRequestToJSON)(requestParameters.patchedOutpostRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OutpostFromJSON)(jsonValue));
        });
    }
    ...
    outpostsLdapListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedLDAPOutpostConfigListFromJSON)(jsonValue));
        });
    }
    /**
     * LDAPProvider Viewset
    ...
    outpostsProxyListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedProxyOutpostConfigListFromJSON)(jsonValue));
        });
    }
    /**
     * ProxyProvider Viewset
    ...
    outpostsServiceConnectionsAllListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedServiceConnectionListFromJSON)(jsonValue));
        });
    }
    /**
     * ServiceConnection Viewset
    ...
    outpostsServiceConnectionsAllRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ServiceConnectionFromJSON)(jsonValue));
        });
    }
    /**
     * ServiceConnection Viewset
    ...
    outpostsServiceConnectionsAllStateRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ServiceConnectionStateFromJSON)(jsonValue));
        });
    }
    /**
     * Get the service connection\'s state
    ...
    outpostsServiceConnectionsDockerCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DockerServiceConnectionRequestToJSON)(requestParameters.dockerServiceConnectionRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DockerServiceConnectionFromJSON)(jsonValue));
        });
    }
    /**
     * DockerServiceConnection Viewset
    ...
    outpostsServiceConnectionsDockerListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedDockerServiceConnectionListFromJSON)(jsonValue));
        });
    }
    /**
     * DockerServiceConnection Viewset
    ...
    outpostsServiceConnectionsDockerPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedDockerServiceConnectionRequestToJSON)(requestParameters.patchedDockerServiceConnectionRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DockerServiceConnectionFromJSON)(jsonValue));
        });
    }
    ...
    outpostsServiceConnectionsKubernetesCreateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.KubernetesServiceConnectionRequestToJSON)(requestParameters.kubernetesServiceConnectionRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.KubernetesServiceConnectionFromJSON)(jsonValue));
        });
    }
    /**
     * KubernetesServiceConnection Viewset
    ...
    outpostsServiceConnectionsKubernetesListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.PaginatedKubernetesServiceConnectionListFromJSON)(jsonValue));
        });
    }
    /**
     * KubernetesServiceConnection Viewset
    ...
    outpostsServiceConnectionsKubernetesPartialUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.PatchedKubernetesServiceConnectionRequestToJSON)(requestParameters.patchedKubernetesServiceConnectionRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.KubernetesServiceConnectionFromJSON)(jsonValue));
        });
    }
