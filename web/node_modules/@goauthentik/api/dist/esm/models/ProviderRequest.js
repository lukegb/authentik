 ...
 */
export function instanceOfProviderRequest(value) {
    let isInstance = true;
...
export function ProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ProviderRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
