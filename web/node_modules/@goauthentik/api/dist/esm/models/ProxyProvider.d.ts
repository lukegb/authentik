 ...
 */
export declare function instanceOfProxyProvider(value: object): value is ProxyProvider;
...
export declare function ProxyProviderToJSON(json: any): ProxyProvider;
export declare function ProxyProviderToJSONTyped(value?: Omit<ProxyProvider, 'pk' | 'component' | 'assigned_application_slug' | 'assigned_application_name' | 'assigned_backchannel_application_slug' | 'assigned_backchannel_application_name' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'client_id' | 'redirect_uris' | 'outpost_set'> | null, ignoreDiscriminator?: boolean): any;
