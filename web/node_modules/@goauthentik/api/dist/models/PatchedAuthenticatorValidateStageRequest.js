...
exports.instanceOfPatchedAuthenticatorValidateStageRequest = instanceOfPatchedAuthenticatorValidateStageRequest;
exports.PatchedAuthenticatorValidateStageRequestFromJSON = PatchedAuthenticatorValidateStageRequestFromJSON;
...
exports.PatchedAuthenticatorValidateStageRequestToJSONTyped = PatchedAuthenticatorValidateStageRequestToJSONTyped;
 ...
 */
function instanceOfPatchedAuthenticatorValidateStageRequest(value) {
    return true;
}
...
function PatchedAuthenticatorValidateStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'notConfiguredAction': json['not_configured_action'] == null ? undefined : (0, NotConfiguredActionEnum_1.NotConfiguredActionEnumFromJSON)(json['not_configured_action']),
        'deviceClasses': json['device_classes'] == null ? undefined : (json['device_classes'].map(DeviceClassesEnum_1.DeviceClassesEnumFromJSON)),
        ...
        'webauthnUserVerification': json['webauthn_user_verification'] == null ? undefined : (0, UserVerificationEnum_1.UserVerificationEnumFromJSON)(json['webauthn_user_verification']),
        'webauthnAllowedDeviceTypes': json['webauthn_allowed_device_types'] == null ? undefined : json['webauthn_allowed_device_types'],
    };
}
function PatchedAuthenticatorValidateStageRequestToJSON(json) {
    return PatchedAuthenticatorValidateStageRequestToJSONTyped(json, false);
}
function PatchedAuthenticatorValidateStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'not_configured_action': (0, NotConfiguredActionEnum_1.NotConfiguredActionEnumToJSON)(value['notConfiguredAction']),
        'device_classes': value['deviceClasses'] == null ? undefined : (value['deviceClasses'].map(DeviceClassesEnum_1.DeviceClassesEnumToJSON)),
