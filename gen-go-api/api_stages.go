...
func (a *StagesApiService) StagesAuthenticatorWebauthnDeviceTypesListExecute(r ApiStagesAuthenticatorWebauthnDeviceTypesListRequest) (*PaginatedWebAuthnDeviceTypeList, *http.Response, error) {
	...
	if r.aaguid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "aaguid", r.aaguid, "")
	}
...
func (a *StagesApiService) StagesAuthenticatorWebauthnListExecute(r ApiStagesAuthenticatorWebauthnListRequest) (*PaginatedAuthenticatorWebAuthnStageList, *http.Response, error) {
	...
	if r.deviceTypeRestrictions != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "device_type_restrictions", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "device_type_restrictions", t, "multi")
		}
	}
	if r.friendlyName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "friendly_name", r.friendlyName, "")
...
type ApiStagesExtAuthCreateRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	extAuthStageRequest *ExtAuthStageRequest
}

func (r ApiStagesExtAuthCreateRequest) ExtAuthStageRequest(extAuthStageRequest ExtAuthStageRequest) ApiStagesExtAuthCreateRequest {
	r.extAuthStageRequest = &extAuthStageRequest
	return r
}

func (r ApiStagesExtAuthCreateRequest) Execute() (*ExtAuthStage, *http.Response, error) {
	return r.ApiService.StagesExtAuthCreateExecute(r)
}

/*
StagesExtAuthCreate Method for StagesExtAuthCreate

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStagesExtAuthCreateRequest
*/
func (a *StagesApiService) StagesExtAuthCreate(ctx context.Context) ApiStagesExtAuthCreateRequest {
	return ApiStagesExtAuthCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ExtAuthStage
func (a *StagesApiService) StagesExtAuthCreateExecute(r ApiStagesExtAuthCreateRequest) (*ExtAuthStage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ExtAuthStage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stages/ext_auth/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.extAuthStageRequest == nil {
		return localVarReturnValue, nil, reportError("extAuthStageRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.extAuthStageRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiStagesExtAuthDestroyRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	stageUuid string
}

func (r ApiStagesExtAuthDestroyRequest) Execute() (*http.Response, error) {
	return r.ApiService.StagesExtAuthDestroyExecute(r)
}

/*
StagesExtAuthDestroy Method for StagesExtAuthDestroy

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param stageUuid A UUID string identifying this ExtAuth Stage.
 @return ApiStagesExtAuthDestroyRequest
*/
func (a *StagesApiService) StagesExtAuthDestroy(ctx context.Context, stageUuid string) ApiStagesExtAuthDestroyRequest {
	return ApiStagesExtAuthDestroyRequest{
		ApiService: a,
		ctx: ctx,
		stageUuid: stageUuid,
...
// Execute executes the request
func (a *StagesApiService) StagesExtAuthDestroyExecute(r ApiStagesExtAuthDestroyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stages/ext_auth/{stage_uuid}/"
	localVarPath = strings.Replace(localVarPath, "{"+"stage_uuid"+"}", url.PathEscape(parameterValueToString(r.stageUuid, "stageUuid")), -1)
...
type ApiStagesExtAuthListRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	name *string
	ordering *string
...
func (r ApiStagesExtAuthListRequest) Name(name string) ApiStagesExtAuthListRequest {
	r.name = &name
	return r
}

// Which field to use when ordering the results.
func (r ApiStagesExtAuthListRequest) Ordering(ordering string) ApiStagesExtAuthListRequest {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiStagesExtAuthListRequest) Page(page int32) ApiStagesExtAuthListRequest {
	r.page = &page
	return r
}

// Number of results to return per page.
func (r ApiStagesExtAuthListRequest) PageSize(pageSize int32) ApiStagesExtAuthListRequest {
	r.pageSize = &pageSize
	return r
}

// A search term.
func (r ApiStagesExtAuthListRequest) Search(search string) ApiStagesExtAuthListRequest {
	r.search = &search
	return r
}

func (r ApiStagesExtAuthListRequest) StageUuid(stageUuid string) ApiStagesExtAuthListRequest {
	r.stageUuid = &stageUuid
	return r
}

func (r ApiStagesExtAuthListRequest) Execute() (*PaginatedExtAuthStageList, *http.Response, error) {
	return r.ApiService.StagesExtAuthListExecute(r)
}

/*
StagesExtAuthList Method for StagesExtAuthList

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStagesExtAuthListRequest
*/
func (a *StagesApiService) StagesExtAuthList(ctx context.Context) ApiStagesExtAuthListRequest {
	return ApiStagesExtAuthListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PaginatedExtAuthStageList
func (a *StagesApiService) StagesExtAuthListExecute(r ApiStagesExtAuthListRequest) (*PaginatedExtAuthStageList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedExtAuthStageList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiStagesExtAuthPartialUpdateRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	stageUuid string
...
func (r ApiStagesExtAuthPartialUpdateRequest) PatchedExtAuthStageRequest(patchedExtAuthStageRequest PatchedExtAuthStageRequest) ApiStagesExtAuthPartialUpdateRequest {
	r.patchedExtAuthStageRequest = &patchedExtAuthStageRequest
	return r
}

func (r ApiStagesExtAuthPartialUpdateRequest) Execute() (*ExtAuthStage, *http.Response, error) {
	return r.ApiService.StagesExtAuthPartialUpdateExecute(r)
}

/*
StagesExtAuthPartialUpdate Method for StagesExtAuthPartialUpdate

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param stageUuid A UUID string identifying this ExtAuth Stage.
 @return ApiStagesExtAuthPartialUpdateRequest
*/
func (a *StagesApiService) StagesExtAuthPartialUpdate(ctx context.Context, stageUuid string) ApiStagesExtAuthPartialUpdateRequest {
	return ApiStagesExtAuthPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
		stageUuid: stageUuid,
...
// Execute executes the request
//  @return ExtAuthStage
func (a *StagesApiService) StagesExtAuthPartialUpdateExecute(r ApiStagesExtAuthPartialUpdateRequest) (*ExtAuthStage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthPartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.patchedExtAuthStageRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiStagesExtAuthRetrieveRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	stageUuid string
}

func (r ApiStagesExtAuthRetrieveRequest) Execute() (*ExtAuthStage, *http.Response, error) {
	return r.ApiService.StagesExtAuthRetrieveExecute(r)
}

/*
StagesExtAuthRetrieve Method for StagesExtAuthRetrieve

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param stageUuid A UUID string identifying this ExtAuth Stage.
 @return ApiStagesExtAuthRetrieveRequest
*/
func (a *StagesApiService) StagesExtAuthRetrieve(ctx context.Context, stageUuid string) ApiStagesExtAuthRetrieveRequest {
	return ApiStagesExtAuthRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		stageUuid: stageUuid,
...
// Execute executes the request
//  @return ExtAuthStage
func (a *StagesApiService) StagesExtAuthRetrieveExecute(r ApiStagesExtAuthRetrieveRequest) (*ExtAuthStage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiStagesExtAuthUpdateRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	stageUuid string
	extAuthStageRequest *ExtAuthStageRequest
...
func (r ApiStagesExtAuthUpdateRequest) ExtAuthStageRequest(extAuthStageRequest ExtAuthStageRequest) ApiStagesExtAuthUpdateRequest {
	r.extAuthStageRequest = &extAuthStageRequest
	return r
}

func (r ApiStagesExtAuthUpdateRequest) Execute() (*ExtAuthStage, *http.Response, error) {
	return r.ApiService.StagesExtAuthUpdateExecute(r)
}

/*
StagesExtAuthUpdate Method for StagesExtAuthUpdate

ExtAuthStage Viewset

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param stageUuid A UUID string identifying this ExtAuth Stage.
 @return ApiStagesExtAuthUpdateRequest
*/
func (a *StagesApiService) StagesExtAuthUpdate(ctx context.Context, stageUuid string) ApiStagesExtAuthUpdateRequest {
	return ApiStagesExtAuthUpdateRequest{
		ApiService: a,
		ctx: ctx,
		stageUuid: stageUuid,
...
// Execute executes the request
//  @return ExtAuthStage
func (a *StagesApiService) StagesExtAuthUpdateExecute(r ApiStagesExtAuthUpdateRequest) (*ExtAuthStage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiStagesExtAuthUsedByListRequest struct {
	ctx context.Context
	ApiService *StagesApiService
	stageUuid string
}

func (r ApiStagesExtAuthUsedByListRequest) Execute() ([]UsedBy, *http.Response, error) {
	return r.ApiService.StagesExtAuthUsedByListExecute(r)
}

/*
StagesExtAuthUsedByList Method for StagesExtAuthUsedByList

Get a list of all objects that use this object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param stageUuid A UUID string identifying this ExtAuth Stage.
 @return ApiStagesExtAuthUsedByListRequest
*/
func (a *StagesApiService) StagesExtAuthUsedByList(ctx context.Context, stageUuid string) ApiStagesExtAuthUsedByListRequest {
	return ApiStagesExtAuthUsedByListRequest{
		ApiService: a,
		ctx: ctx,
		stageUuid: stageUuid,
...
// Execute executes the request
//  @return []UsedBy
func (a *StagesApiService) StagesExtAuthUsedByListExecute(r ApiStagesExtAuthUsedByListRequest) ([]UsedBy, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StagesApiService.StagesExtAuthUsedByList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stages/ext_auth/{stage_uuid}/used_by/"
	localVarPath = strings.Replace(localVarPath, "{"+"stage_uuid"+"}", url.PathEscape(parameterValueToString(r.stageUuid, "stageUuid")), -1)
...
func (a *StagesApiService) StagesIdentificationListExecute(r ApiStagesIdentificationListRequest) (*PaginatedIdentificationStageList, *http.Response, error) {
	...
	if r.captchaStage != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "captcha_stage", r.captchaStage, "")
	}
...
func (a *StagesApiService) StagesPasswordListExecute(r ApiStagesPasswordListRequest) (*PaginatedPasswordStageList, *http.Response, error) {
	...
	if r.allowShowPassword != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "allow_show_password", r.allowShowPassword, "")
	}
	if r.configureFlow != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "configure_flow", r.configureFlow, "")
	}
...
func (a *StagesApiService) StagesSourceListExecute(r ApiStagesSourceListRequest) (*PaginatedSourceStageList, *http.Response, error) {
	...
	if r.resumeTimeout != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "resume_timeout", r.resumeTimeout, "")
	}
	if r.search != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "search", r.search, "")
	}
...
func (a *StagesApiService) StagesUserLoginListExecute(r ApiStagesUserLoginListRequest) (*PaginatedUserLoginStageList, *http.Response, error) {
	...
	if r.geoipBinding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "geoip_binding", r.geoipBinding, "")
	}
	if r.name != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "name", r.name, "")
	}
	if r.networkBinding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "network_binding", r.networkBinding, "")
	}
	if r.ordering != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ordering", r.ordering, "")
	}
