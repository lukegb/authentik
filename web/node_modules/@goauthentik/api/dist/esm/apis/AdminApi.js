...
import { AppFromJSON, LoginMetricsFromJSON, PatchedSettingsRequestToJSON, SettingsFromJSON, SettingsRequestToJSON, SystemInfoFromJSON, VersionFromJSON, VersionHistoryFromJSON, WorkerFromJSON, } from '../models/index';
/**
 *
 */
    ...
    adminVersionHistoryRetrieveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['id'] == null) {
                throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling adminVersionHistoryRetrieve().');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (this.configuration && this.configuration.accessToken) {
