 ...
 */
export function instanceOfAutoSubmitChallengeResponseRequest(value: object): boolean {
    let isInstance = true;
...
export function AutoSubmitChallengeResponseRequestToJSON(value?: AutoSubmitChallengeResponseRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
