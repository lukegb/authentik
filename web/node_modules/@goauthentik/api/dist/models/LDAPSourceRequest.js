...
exports.instanceOfLDAPSourceRequest = instanceOfLDAPSourceRequest;
exports.LDAPSourceRequestFromJSON = LDAPSourceRequestFromJSON;
...
exports.LDAPSourceRequestToJSONTyped = LDAPSourceRequestToJSONTyped;
 ...
 */
function instanceOfLDAPSourceRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('slug' in value) || value['slug'] === undefined)
        return false;
    if (!('serverUri' in value) || value['serverUri'] === undefined)
        return false;
    if (!('baseDn' in value) || value['baseDn'] === undefined)
        return false;
    return true;
}
function LDAPSourceRequestFromJSON(json) {
    return LDAPSourceRequestFromJSONTyped(json, false);
}
function LDAPSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function LDAPSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
