...
export function SAMLSourcePropertyMappingRequestToJSON(json) {
    return SAMLSourcePropertyMappingRequestToJSONTyped(json, false);
}
export function SAMLSourcePropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
