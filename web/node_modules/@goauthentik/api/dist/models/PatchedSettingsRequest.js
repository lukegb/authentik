...
exports.PatchedSettingsRequestToJSONTyped = PatchedSettingsRequestToJSONTyped;
/**
...
function PatchedSettingsRequestToJSON(json) {
    return PatchedSettingsRequestToJSONTyped(json, false);
}
function PatchedSettingsRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
