...
exports.RadiusProviderToJSONTyped = RadiusProviderToJSONTyped;
/**
...
function RadiusProviderToJSON(json) {
    return RadiusProviderToJSONTyped(json, false);
}
function RadiusProviderToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
