...
export const AppEnum = {
    ...
    AuthentikStagesExtAuth: 'authentik.stages.ext_auth',
...
export function AppEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function AppEnumToJSON(value) {
    return value;
}
export function AppEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
