...
exports.instanceOfUserDeleteStage = instanceOfUserDeleteStage;
exports.UserDeleteStageFromJSON = UserDeleteStageFromJSON;
exports.UserDeleteStageFromJSONTyped = UserDeleteStageFromJSONTyped;
exports.UserDeleteStageToJSON = UserDeleteStageToJSON;
exports.UserDeleteStageToJSONTyped = UserDeleteStageToJSONTyped;
const FlowSet_1 = require("./FlowSet");
/**
 * Check if a given object implements the UserDeleteStage interface.
 */
function instanceOfUserDeleteStage(value) {
...
function UserDeleteStageFromJSON(json) {
    return UserDeleteStageFromJSONTyped(json, false);
}
function UserDeleteStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UserDeleteStageToJSON(json) {
    return UserDeleteStageToJSONTyped(json, false);
}
function UserDeleteStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
