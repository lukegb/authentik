 ...
 */
export function instanceOfReputationPolicyRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function ReputationPolicyRequestFromJSON(json) {
    return ReputationPolicyRequestFromJSONTyped(json, false);
}
export function ReputationPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ReputationPolicyRequestToJSON(json) {
    return ReputationPolicyRequestToJSONTyped(json, false);
}
export function ReputationPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
