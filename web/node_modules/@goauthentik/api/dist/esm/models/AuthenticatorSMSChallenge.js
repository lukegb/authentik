...
export function AuthenticatorSMSChallengeFromJSON(json) {
    return AuthenticatorSMSChallengeFromJSONTyped(json, false);
}
export function AuthenticatorSMSChallengeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'phoneNumberRequired': !exists(json, 'phone_number_required') ? undefined : json['phone_number_required'],
    };
}
export function AuthenticatorSMSChallengeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
