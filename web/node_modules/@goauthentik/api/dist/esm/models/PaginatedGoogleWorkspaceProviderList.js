...
export function PaginatedGoogleWorkspaceProviderListToJSON(json) {
    return PaginatedGoogleWorkspaceProviderListToJSONTyped(json, false);
}
export function PaginatedGoogleWorkspaceProviderListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
