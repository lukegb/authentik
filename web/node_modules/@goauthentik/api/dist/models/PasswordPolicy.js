...
exports.PasswordPolicyToJSONTyped = PasswordPolicyToJSONTyped;
/**
...
function PasswordPolicyToJSON(json) {
    return PasswordPolicyToJSONTyped(json, false);
}
function PasswordPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
