 ...
 */
export function instanceOfAuthenticatorSMSChallengeResponseRequest(value: object): boolean {
    let isInstance = true;
...
export function AuthenticatorSMSChallengeResponseRequestToJSON(value?: AuthenticatorSMSChallengeResponseRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
