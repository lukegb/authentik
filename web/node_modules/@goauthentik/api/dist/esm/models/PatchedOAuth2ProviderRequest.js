 ...
 */
export function instanceOfPatchedOAuth2ProviderRequest(value) {
    return true;
}
export function PatchedOAuth2ProviderRequestFromJSON(json) {
    return PatchedOAuth2ProviderRequestFromJSONTyped(json, false);
}
export function PatchedOAuth2ProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'redirectUris': json['redirect_uris'] == null ? undefined : (json['redirect_uris'].map(RedirectURIRequestFromJSON)),
...
export function PatchedOAuth2ProviderRequestToJSON(json) {
    return PatchedOAuth2ProviderRequestToJSONTyped(json, false);
}
export function PatchedOAuth2ProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'redirect_uris': value['redirectUris'] == null ? undefined : (value['redirectUris'].map(RedirectURIRequestToJSON)),
