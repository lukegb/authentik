...
exports.SAMLSourceToJSONTyped = SAMLSourceToJSONTyped;
...
function instanceOfSAMLSource(value) {
    ...
    if (!('preAuthenticationFlow' in value) || value['preAuthenticationFlow'] === undefined)
        return false;
    if (!('ssoUrl' in value) || value['ssoUrl'] === undefined)
        return false;
    return true;
}
...
function SAMLSourceToJSON(json) {
    return SAMLSourceToJSONTyped(json, false);
}
function SAMLSourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
