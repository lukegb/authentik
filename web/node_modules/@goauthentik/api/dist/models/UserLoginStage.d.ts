 ...
 */
export declare function instanceOfUserLoginStage(value: object): value is UserLoginStage;
...
export declare function UserLoginStageToJSON(json: any): UserLoginStage;
export declare function UserLoginStageToJSONTyped(value?: Omit<UserLoginStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
