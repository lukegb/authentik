...
func (o ExtraRoleObjectPermission) ToMap() (map[string]interface{}, error) {
	...
	// skip: id is readOnly
	// skip: codename is readOnly
	// skip: model is readOnly
	// skip: app_label is readOnly
	// skip: object_pk is readOnly
	// skip: name is readOnly
	// skip: app_label_verbose is readOnly
	// skip: model_verbose is readOnly
