...
// checks if the SAMLSourcePropertyMappingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SAMLSourcePropertyMappingRequest{}
...
func (o SAMLSourcePropertyMappingRequest) ToMap() (map[string]interface{}, error) {
