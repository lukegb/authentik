 ...
 */
export function instanceOfPatchedProxyProviderRequest(value) {
    return true;
}
export function PatchedProxyProviderRequestFromJSON(json) {
    return PatchedProxyProviderRequestFromJSONTyped(json, false);
}
export function PatchedProxyProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedProxyProviderRequestToJSON(json) {
    return PatchedProxyProviderRequestToJSONTyped(json, false);
}
export function PatchedProxyProviderRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
