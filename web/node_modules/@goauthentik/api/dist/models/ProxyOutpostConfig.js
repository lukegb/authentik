...
exports.instanceOfProxyOutpostConfig = instanceOfProxyOutpostConfig;
exports.ProxyOutpostConfigFromJSON = ProxyOutpostConfigFromJSON;
exports.ProxyOutpostConfigFromJSONTyped = ProxyOutpostConfigFromJSONTyped;
exports.ProxyOutpostConfigToJSON = ProxyOutpostConfigToJSON;
exports.ProxyOutpostConfigToJSONTyped = ProxyOutpostConfigToJSONTyped;
const OpenIDConnectConfiguration_1 = require("./OpenIDConnectConfiguration");
const ProxyMode_1 = require("./ProxyMode");
/**
 * Check if a given object implements the ProxyOutpostConfig interface.
 */
function instanceOfProxyOutpostConfig(value) {
    if (!('pk' in value) || value['pk'] === undefined)
        return false;
    if (!('name' in value) || value['name'] === undefined)
        return false;
    if (!('externalHost' in value) || value['externalHost'] === undefined)
        return false;
    if (!('oidcConfiguration' in value) || value['oidcConfiguration'] === undefined)
        return false;
    if (!('accessTokenValidity' in value) || value['accessTokenValidity'] === undefined)
        return false;
    if (!('scopesToRequest' in value) || value['scopesToRequest'] === undefined)
        return false;
...
function ProxyOutpostConfigFromJSON(json) {
    return ProxyOutpostConfigFromJSONTyped(json, false);
}
function ProxyOutpostConfigFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'oidcConfiguration': (0, OpenIDConnectConfiguration_1.OpenIDConnectConfigurationFromJSON)(json['oidc_configuration']),
        ...
        'mode': json['mode'] == null ? undefined : (0, ProxyMode_1.ProxyModeFromJSON)(json['mode']),
...
function ProxyOutpostConfigToJSON(json) {
    return ProxyOutpostConfigToJSONTyped(json, false);
}
function ProxyOutpostConfigToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
