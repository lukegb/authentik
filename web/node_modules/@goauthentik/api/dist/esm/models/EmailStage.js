 ...
 */
export function instanceOfEmailStage(value) {
    let isInstance = true;
...
export function EmailStageFromJSON(json) {
    return EmailStageFromJSONTyped(json, false);
}
export function EmailStageFromJSONTyped(json, ignoreDiscriminator) {
...
export function EmailStageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
