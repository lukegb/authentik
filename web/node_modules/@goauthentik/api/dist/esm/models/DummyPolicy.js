 ...
 */
export function instanceOfDummyPolicy(value) {
...
export function DummyPolicyFromJSON(json) {
    return DummyPolicyFromJSONTyped(json, false);
}
export function DummyPolicyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DummyPolicyToJSON(json) {
    return DummyPolicyToJSONTyped(json, false);
}
export function DummyPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
