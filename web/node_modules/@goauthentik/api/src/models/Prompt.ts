...
export function PromptFromJSONTyped(json: any, ignoreDiscriminator: boolean): Prompt {
    ...
    return {
        ...
        'promptstageSet': json['promptstage_set'] == null ? undefined : ((json['promptstage_set'] as Array<any>).map(StageFromJSON)),
...
export function PromptToJSONTyped(value?: Omit<Prompt, 'pk'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'order': value['order'],
        'promptstage_set': value['promptstageSet'] == null ? undefined : ((value['promptstageSet'] as Array<any>).map(StageToJSON)),
