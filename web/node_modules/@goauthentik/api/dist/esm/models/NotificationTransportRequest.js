 ...
 */
import { NotificationTransportModeEnumFromJSON, NotificationTransportModeEnumToJSON, } from './NotificationTransportModeEnum';
/**
 * Check if a given object implements the NotificationTransportRequest interface.
 */
export function instanceOfNotificationTransportRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
export function NotificationTransportRequestFromJSON(json) {
    return NotificationTransportRequestFromJSONTyped(json, false);
}
export function NotificationTransportRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NotificationTransportRequestToJSON(json) {
    return NotificationTransportRequestToJSONTyped(json, false);
}
export function NotificationTransportRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
