...
exports.PatchedBrandRequestToJSONTyped = PatchedBrandRequestToJSONTyped;
/**
...
function PatchedBrandRequestToJSON(json) {
    return PatchedBrandRequestToJSONTyped(json, false);
}
function PatchedBrandRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
