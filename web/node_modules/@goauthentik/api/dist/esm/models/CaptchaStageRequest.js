 ...
 */
export function instanceOfCaptchaStageRequest(value) {
...
export function CaptchaStageRequestFromJSON(json) {
    return CaptchaStageRequestFromJSONTyped(json, false);
}
export function CaptchaStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CaptchaStageRequestToJSON(json) {
    return CaptchaStageRequestToJSONTyped(json, false);
}
export function CaptchaStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
