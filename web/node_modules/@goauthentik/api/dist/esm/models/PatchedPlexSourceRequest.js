 ...
 */
export function instanceOfPatchedPlexSourceRequest(value) {
    return true;
}
export function PatchedPlexSourceRequestFromJSON(json) {
    return PatchedPlexSourceRequestFromJSONTyped(json, false);
}
export function PatchedPlexSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedPlexSourceRequestToJSON(json) {
    return PatchedPlexSourceRequestToJSONTyped(json, false);
}
export function PatchedPlexSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
