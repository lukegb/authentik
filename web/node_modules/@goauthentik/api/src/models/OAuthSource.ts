...
export function OAuthSourceToJSONTyped(value?: Omit<OAuthSource, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'managed'|'icon'|'callback_url'|'type'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
