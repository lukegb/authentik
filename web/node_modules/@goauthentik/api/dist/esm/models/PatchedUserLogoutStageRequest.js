 ...
 */
export function instanceOfPatchedUserLogoutStageRequest(value) {
    return true;
}
export function PatchedUserLogoutStageRequestFromJSON(json) {
    return PatchedUserLogoutStageRequestFromJSONTyped(json, false);
}
export function PatchedUserLogoutStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedUserLogoutStageRequestToJSON(json) {
    return PatchedUserLogoutStageRequestToJSONTyped(json, false);
}
export function PatchedUserLogoutStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
