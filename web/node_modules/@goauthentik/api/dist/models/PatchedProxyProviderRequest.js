...
exports.PatchedProxyProviderRequestToJSON = exports.PatchedProxyProviderRequestFromJSONTyped = exports.PatchedProxyProviderRequestFromJSON = exports.instanceOfPatchedProxyProviderRequest = void 0;
const runtime_1 = require("../runtime");
const ProxyMode_1 = require("./ProxyMode");
/**
 * Check if a given object implements the PatchedProxyProviderRequest interface.
 */
function instanceOfPatchedProxyProviderRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPatchedProxyProviderRequest = instanceOfPatchedProxyProviderRequest;
function PatchedProxyProviderRequestFromJSON(json) {
    return PatchedProxyProviderRequestFromJSONTyped(json, false);
}
exports.PatchedProxyProviderRequestFromJSON = PatchedProxyProviderRequestFromJSON;
function PatchedProxyProviderRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'skipPathRegex': !(0, runtime_1.exists)(json, 'skip_path_regex') ? undefined : json['skip_path_regex'],
        'basicAuthEnabled': !(0, runtime_1.exists)(json, 'basic_auth_enabled') ? undefined : json['basic_auth_enabled'],
...
exports.PatchedProxyProviderRequestFromJSONTyped = PatchedProxyProviderRequestFromJSONTyped;
function PatchedProxyProviderRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PatchedProxyProviderRequestToJSON = PatchedProxyProviderRequestToJSON;
