 ...
 */
export function instanceOfPatchedEventMatcherPolicyRequest(value) {
    return true;
}
export function PatchedEventMatcherPolicyRequestFromJSON(json) {
    return PatchedEventMatcherPolicyRequestFromJSONTyped(json, false);
}
export function PatchedEventMatcherPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedEventMatcherPolicyRequestToJSON(json) {
    return PatchedEventMatcherPolicyRequestToJSONTyped(json, false);
}
export function PatchedEventMatcherPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
