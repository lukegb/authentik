...
exports.instanceOfEventMatcherPolicy = instanceOfEventMatcherPolicy;
exports.EventMatcherPolicyFromJSON = EventMatcherPolicyFromJSON;
...
exports.EventMatcherPolicyToJSONTyped = EventMatcherPolicyToJSONTyped;
 ...
 */
function instanceOfEventMatcherPolicy(value) {
...
function EventMatcherPolicyFromJSON(json) {
    return EventMatcherPolicyFromJSONTyped(json, false);
}
function EventMatcherPolicyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'action': json['action'] == null ? undefined : (0, EventActions_1.EventActionsFromJSON)(json['action']),
        'clientIp': json['client_ip'] == null ? undefined : json['client_ip'],
        'app': json['app'] == null ? undefined : (0, AppEnum_1.AppEnumFromJSON)(json['app']),
        'model': json['model'] == null ? undefined : (0, ModelEnum_1.ModelEnumFromJSON)(json['model']),
    };
}
function EventMatcherPolicyToJSON(json) {
    return EventMatcherPolicyToJSONTyped(json, false);
}
function EventMatcherPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
