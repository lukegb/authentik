...
// checks if the GroupPlexSourceConnectionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPlexSourceConnectionRequest{}
...
func (o GroupPlexSourceConnectionRequest) ToMap() (map[string]interface{}, error) {
