 ...
 */
export declare function instanceOfRACPropertyMapping(value: object): value is RACPropertyMapping;
...
export declare function RACPropertyMappingToJSON(json: any): RACPropertyMapping;
export declare function RACPropertyMappingToJSONTyped(value?: Omit<RACPropertyMapping, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
