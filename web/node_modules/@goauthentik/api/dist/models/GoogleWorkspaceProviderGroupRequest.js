...
exports.GoogleWorkspaceProviderGroupRequestToJSONTyped = GoogleWorkspaceProviderGroupRequestToJSONTyped;
/**
...
function instanceOfGoogleWorkspaceProviderGroupRequest(value) {
    if (!('googleId' in value) || value['googleId'] === undefined)
        return false;
...
function GoogleWorkspaceProviderGroupRequestToJSON(json) {
    return GoogleWorkspaceProviderGroupRequestToJSONTyped(json, false);
}
function GoogleWorkspaceProviderGroupRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
