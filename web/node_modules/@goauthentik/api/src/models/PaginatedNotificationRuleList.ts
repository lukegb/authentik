 ...
 */
export function instanceOfPaginatedNotificationRuleList(value: object): boolean {
    let isInstance = true;
...
export function PaginatedNotificationRuleListToJSON(value?: PaginatedNotificationRuleList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
