...
func Test_api_AdminApiService(t *testing.T) {
	...
	t.Run("Test AdminApiService AdminVersionHistoryList", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AdminApi.AdminVersionHistoryList(context.Background()).Execute()
	...
	t.Run("Test AdminApiService AdminVersionHistoryRetrieve", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.AdminApi.AdminVersionHistoryRetrieve(context.Background(), id).Execute()
	...
	t.Run("Test AdminApiService AdminWorkersList", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AdminApi.AdminWorkersList(context.Background()).Execute()
