...
export function SCIMMappingRequestFromJSON(json) {
    return SCIMMappingRequestFromJSONTyped(json, false);
}
export function SCIMMappingRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SCIMMappingRequestToJSON(json) {
    return SCIMMappingRequestToJSONTyped(json, false);
}
export function SCIMMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
