 ...
 */
export declare function instanceOfExtraRoleObjectPermission(value: object): value is ExtraRoleObjectPermission;
...
export declare function ExtraRoleObjectPermissionToJSON(json: any): ExtraRoleObjectPermission;
export declare function ExtraRoleObjectPermissionToJSONTyped(value?: Omit<ExtraRoleObjectPermission, 'id' | 'codename' | 'model' | 'app_label' | 'name' | 'app_label_verbose' | 'model_verbose' | 'object_description'> | null, ignoreDiscriminator?: boolean): any;
