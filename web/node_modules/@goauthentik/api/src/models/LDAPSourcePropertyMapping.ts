 ...
 */
export function instanceOfLDAPSourcePropertyMapping(value: object): value is LDAPSourcePropertyMapping {
...
export function LDAPSourcePropertyMappingToJSONTyped(value?: Omit<LDAPSourcePropertyMapping, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
