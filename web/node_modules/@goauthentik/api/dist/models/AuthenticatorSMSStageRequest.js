...
exports.AuthenticatorSMSStageRequestToJSON = exports.AuthenticatorSMSStageRequestFromJSONTyped = exports.AuthenticatorSMSStageRequestFromJSON = exports.instanceOfAuthenticatorSMSStageRequest = void 0;
 ...
 */
function instanceOfAuthenticatorSMSStageRequest(value) {
    let isInstance = true;
...
exports.instanceOfAuthenticatorSMSStageRequest = instanceOfAuthenticatorSMSStageRequest;
function AuthenticatorSMSStageRequestFromJSON(json) {
    return AuthenticatorSMSStageRequestFromJSONTyped(json, false);
}
exports.AuthenticatorSMSStageRequestFromJSON = AuthenticatorSMSStageRequestFromJSON;
function AuthenticatorSMSStageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
function AuthenticatorSMSStageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
