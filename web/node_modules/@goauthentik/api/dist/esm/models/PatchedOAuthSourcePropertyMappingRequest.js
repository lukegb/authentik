...
export function PatchedOAuthSourcePropertyMappingRequestToJSON(json) {
    return PatchedOAuthSourcePropertyMappingRequestToJSONTyped(json, false);
}
export function PatchedOAuthSourcePropertyMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
