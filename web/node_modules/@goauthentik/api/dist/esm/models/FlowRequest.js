 ...
 */
export function instanceOfFlowRequest(value) {
...
export function FlowRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function FlowRequestToJSON(json) {
    return FlowRequestToJSONTyped(json, false);
}
export function FlowRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
