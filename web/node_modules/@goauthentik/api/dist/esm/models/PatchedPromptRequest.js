 ...
 */
export function instanceOfPatchedPromptRequest(value) {
    let isInstance = true;
    return isInstance;
}
export function PatchedPromptRequestFromJSON(json) {
    return PatchedPromptRequestFromJSONTyped(json, false);
}
export function PatchedPromptRequestFromJSONTyped(json, ignoreDiscriminator) {
