...
exports.BrandRequestToJSONTyped = BrandRequestToJSONTyped;
/**
...
function BrandRequestToJSON(json) {
    return BrandRequestToJSONTyped(json, false);
}
function BrandRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
