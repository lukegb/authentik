...
// checks if the RedirectStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RedirectStage{}
...
func (o RedirectStage) ToMap() (map[string]interface{}, error) {
