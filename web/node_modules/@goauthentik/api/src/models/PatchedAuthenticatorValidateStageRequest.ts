 ...
 */
export function instanceOfPatchedAuthenticatorValidateStageRequest(value: object): boolean {
    let isInstance = true;
...
export function PatchedAuthenticatorValidateStageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedAuthenticatorValidateStageRequest {
...
export function PatchedAuthenticatorValidateStageRequestToJSON(value?: PatchedAuthenticatorValidateStageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
