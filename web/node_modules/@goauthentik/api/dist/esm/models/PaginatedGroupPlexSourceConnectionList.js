...
export function PaginatedGroupPlexSourceConnectionListToJSON(json) {
    return PaginatedGroupPlexSourceConnectionListToJSONTyped(json, false);
}
export function PaginatedGroupPlexSourceConnectionListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
