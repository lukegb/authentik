...
exports.SCIMSourceToJSONTyped = SCIMSourceToJSONTyped;
...
function instanceOfSCIMSource(value) {
    ...
    if (!('managed' in value) || value['managed'] === undefined)
        return false;
    if (!('rootUrl' in value) || value['rootUrl'] === undefined)
        return false;
...
function SCIMSourceToJSON(json) {
    return SCIMSourceToJSONTyped(json, false);
}
function SCIMSourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
