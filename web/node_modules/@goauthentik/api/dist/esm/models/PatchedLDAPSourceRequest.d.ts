 ...
 */
export declare function instanceOfPatchedLDAPSourceRequest(value: object): value is PatchedLDAPSourceRequest;
export declare function PatchedLDAPSourceRequestFromJSON(json: any): PatchedLDAPSourceRequest;
export declare function PatchedLDAPSourceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedLDAPSourceRequest;
export declare function PatchedLDAPSourceRequestToJSON(json: any): PatchedLDAPSourceRequest;
export declare function PatchedLDAPSourceRequestToJSONTyped(value?: PatchedLDAPSourceRequest | null, ignoreDiscriminator?: boolean): any;
