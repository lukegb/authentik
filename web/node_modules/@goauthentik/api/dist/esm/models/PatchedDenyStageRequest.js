 ...
 */
export function instanceOfPatchedDenyStageRequest(value) {
    let isInstance = true;
    return isInstance;
}
export function PatchedDenyStageRequestFromJSON(json) {
    return PatchedDenyStageRequestFromJSONTyped(json, false);
}
export function PatchedDenyStageRequestFromJSONTyped(json, ignoreDiscriminator) {
