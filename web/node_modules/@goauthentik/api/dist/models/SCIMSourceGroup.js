...
exports.SCIMSourceGroupToJSONTyped = SCIMSourceGroupToJSONTyped;
...
function SCIMSourceGroupToJSON(json) {
    return SCIMSourceGroupToJSONTyped(json, false);
}
function SCIMSourceGroupToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
