 ...
 */
export function instanceOfAuthenticatorStaticStage(value) {
    let isInstance = true;
...
export function AuthenticatorStaticStageFromJSONTyped(json, ignoreDiscriminator) {
...
export function AuthenticatorStaticStageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
