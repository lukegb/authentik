...
func Test_api_EnterpriseApiService(t *testing.T) {
	...
	t.Run("Test EnterpriseApiService EnterpriseLicenseInstallIdRetrieve", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.EnterpriseApi.EnterpriseLicenseInstallIdRetrieve(context.Background()).Execute()
