...
exports.SCIMSourcePropertyMappingToJSONTyped = SCIMSourcePropertyMappingToJSONTyped;
/**
...
function SCIMSourcePropertyMappingToJSON(json) {
    return SCIMSourcePropertyMappingToJSONTyped(json, false);
}
function SCIMSourcePropertyMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
