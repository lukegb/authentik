...
exports.instanceOfUserWriteStageRequest = instanceOfUserWriteStageRequest;
exports.UserWriteStageRequestFromJSON = UserWriteStageRequestFromJSON;
...
exports.UserWriteStageRequestToJSONTyped = UserWriteStageRequestToJSONTyped;
 ...
 */
function instanceOfUserWriteStageRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
function UserWriteStageRequestFromJSON(json) {
    return UserWriteStageRequestFromJSONTyped(json, false);
}
function UserWriteStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'userCreationMode': json['user_creation_mode'] == null ? undefined : (0, UserCreationModeEnum_1.UserCreationModeEnumFromJSON)(json['user_creation_mode']),
        ...
        'userType': json['user_type'] == null ? undefined : (0, UserTypeEnum_1.UserTypeEnumFromJSON)(json['user_type']),
        'userPathTemplate': json['user_path_template'] == null ? undefined : json['user_path_template'],
    };
}
function UserWriteStageRequestToJSON(json) {
    return UserWriteStageRequestToJSONTyped(json, false);
}
function UserWriteStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
