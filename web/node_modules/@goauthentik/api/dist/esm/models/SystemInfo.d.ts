 ...
 */
export declare function instanceOfSystemInfo(value: object): value is SystemInfo;
...
export declare function SystemInfoToJSON(json: any): SystemInfo;
export declare function SystemInfoToJSONTyped(value?: Omit<SystemInfo, 'http_headers' | 'http_host' | 'http_is_secure' | 'brand' | 'server_time' | 'embedded_outpost_disabled' | 'embedded_outpost_host'> | null, ignoreDiscriminator?: boolean): any;
