...
exports.PatchedLDAPSourceRequestToJSON = exports.PatchedLDAPSourceRequestFromJSONTyped = exports.PatchedLDAPSourceRequestFromJSON = exports.instanceOfPatchedLDAPSourceRequest = void 0;
 ...
 */
function instanceOfPatchedLDAPSourceRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPatchedLDAPSourceRequest = instanceOfPatchedLDAPSourceRequest;
function PatchedLDAPSourceRequestFromJSON(json) {
    return PatchedLDAPSourceRequestFromJSONTyped(json, false);
}
exports.PatchedLDAPSourceRequestFromJSON = PatchedLDAPSourceRequestFromJSON;
function PatchedLDAPSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'userObjectFilter': !(0, runtime_1.exists)(json, 'user_object_filter') ? undefined : json['user_object_filter'],
...
function PatchedLDAPSourceRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
