 ...
 */
export function instanceOfPasswordStage(value) {
...
export function PasswordStageFromJSON(json) {
    return PasswordStageFromJSONTyped(json, false);
}
export function PasswordStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PasswordStageToJSON(json) {
    return PasswordStageToJSONTyped(json, false);
}
export function PasswordStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
