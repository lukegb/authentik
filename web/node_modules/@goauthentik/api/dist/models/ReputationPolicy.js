...
exports.ReputationPolicyToJSONTyped = ReputationPolicyToJSONTyped;
/**
...
function ReputationPolicyToJSON(json) {
    return ReputationPolicyToJSONTyped(json, false);
}
function ReputationPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
