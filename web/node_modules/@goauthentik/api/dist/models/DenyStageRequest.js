...
exports.DenyStageRequestToJSON = exports.DenyStageRequestFromJSONTyped = exports.DenyStageRequestFromJSON = exports.instanceOfDenyStageRequest = void 0;
const runtime_1 = require("../runtime");
const FlowSetRequest_1 = require("./FlowSetRequest");
/**
 * Check if a given object implements the DenyStageRequest interface.
 */
function instanceOfDenyStageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    return isInstance;
}
exports.instanceOfDenyStageRequest = instanceOfDenyStageRequest;
function DenyStageRequestFromJSON(json) {
    return DenyStageRequestFromJSONTyped(json, false);
}
exports.DenyStageRequestFromJSON = DenyStageRequestFromJSON;
function DenyStageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
function DenyStageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
