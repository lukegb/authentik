 ...
 */
export function instanceOfPatchedOAuth2ProviderRequest(value: object): boolean {
    let isInstance = true;
...
export function PatchedOAuth2ProviderRequestToJSON(value?: PatchedOAuth2ProviderRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
