 ...
 */
export function instanceOfFlowSetRequest(value: object): boolean {
    let isInstance = true;
...
export function FlowSetRequestFromJSON(json: any): FlowSetRequest {
    return FlowSetRequestFromJSONTyped(json, false);
}

export function FlowSetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowSetRequest {
...
export function FlowSetRequestToJSON(value?: FlowSetRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
