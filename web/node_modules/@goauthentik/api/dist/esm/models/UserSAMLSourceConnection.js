 ...
 */
export function instanceOfUserSAMLSourceConnection(value) {
...
export function UserSAMLSourceConnectionFromJSON(json) {
    return UserSAMLSourceConnectionFromJSONTyped(json, false);
}
export function UserSAMLSourceConnectionFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserSAMLSourceConnectionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
