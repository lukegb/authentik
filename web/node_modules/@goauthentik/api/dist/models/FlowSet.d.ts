 ...
 */
export declare function instanceOfFlowSet(value: object): value is FlowSet;
export declare function FlowSetFromJSON(json: any): FlowSet;
export declare function FlowSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowSet;
export declare function FlowSetToJSON(json: any): FlowSet;
export declare function FlowSetToJSONTyped(value?: Omit<FlowSet, 'pk' | 'policybindingmodel_ptr_id' | 'background' | 'export_url'> | null, ignoreDiscriminator?: boolean): any;
