...
exports.ApplicationToJSONTyped = ApplicationToJSONTyped;
...
function instanceOfApplication(value) {
    ...
    if (!('launchUrl' in value) || value['launchUrl'] === undefined)
        return false;
    if (!('metaIcon' in value) || value['metaIcon'] === undefined)
        return false;
    return true;
}
...
function ApplicationFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'providerObj': (0, Provider_1.ProviderFromJSON)(json['provider_obj']),
        'backchannelProviders': json['backchannel_providers'] == null ? undefined : json['backchannel_providers'],
        'backchannelProvidersObj': (json['backchannel_providers_obj'].map(Provider_1.ProviderFromJSON)),
