 ...
 */
export declare function instanceOfLDAPSource(value: object): value is LDAPSource;
export declare function LDAPSourceFromJSON(json: any): LDAPSource;
export declare function LDAPSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): LDAPSource;
export declare function LDAPSourceToJSON(json: any): LDAPSource;
export declare function LDAPSourceToJSONTyped(value?: Omit<LDAPSource, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name' | 'managed' | 'icon' | 'connectivity'> | null, ignoreDiscriminator?: boolean): any;
