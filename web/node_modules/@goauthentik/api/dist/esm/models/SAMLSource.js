 ...
 */
export function instanceOfSAMLSource(value) {
...
export function SAMLSourceFromJSON(json) {
    return SAMLSourceFromJSONTyped(json, false);
}
export function SAMLSourceFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SAMLSourceToJSON(json) {
    return SAMLSourceToJSONTyped(json, false);
}
export function SAMLSourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
