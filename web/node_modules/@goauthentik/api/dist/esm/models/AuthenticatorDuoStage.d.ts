 ...
 */
export declare function instanceOfAuthenticatorDuoStage(value: object): value is AuthenticatorDuoStage;
...
export declare function AuthenticatorDuoStageToJSON(json: any): AuthenticatorDuoStage;
export declare function AuthenticatorDuoStageToJSONTyped(value?: Omit<AuthenticatorDuoStage, 'pk' | 'component' | 'verbose_name' | 'verbose_name_plural' | 'meta_model_name'> | null, ignoreDiscriminator?: boolean): any;
