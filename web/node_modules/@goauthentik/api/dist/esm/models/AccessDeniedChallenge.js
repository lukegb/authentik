...
export function AccessDeniedChallengeFromJSON(json) {
    return AccessDeniedChallengeFromJSONTyped(json, false);
}
export function AccessDeniedChallengeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AccessDeniedChallengeToJSON(json) {
    return AccessDeniedChallengeToJSONTyped(json, false);
}
export function AccessDeniedChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
