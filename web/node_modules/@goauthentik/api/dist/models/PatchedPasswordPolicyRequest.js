...
exports.instanceOfPatchedPasswordPolicyRequest = instanceOfPatchedPasswordPolicyRequest;
exports.PatchedPasswordPolicyRequestFromJSON = PatchedPasswordPolicyRequestFromJSON;
exports.PatchedPasswordPolicyRequestFromJSONTyped = PatchedPasswordPolicyRequestFromJSONTyped;
exports.PatchedPasswordPolicyRequestToJSON = PatchedPasswordPolicyRequestToJSON;
exports.PatchedPasswordPolicyRequestToJSONTyped = PatchedPasswordPolicyRequestToJSONTyped;
/**
 * Check if a given object implements the PatchedPasswordPolicyRequest interface.
 */
function instanceOfPatchedPasswordPolicyRequest(value) {
    return true;
}
function PatchedPasswordPolicyRequestFromJSON(json) {
    return PatchedPasswordPolicyRequestFromJSONTyped(json, false);
}
function PatchedPasswordPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PatchedPasswordPolicyRequestToJSON(json) {
    return PatchedPasswordPolicyRequestToJSONTyped(json, false);
}
function PatchedPasswordPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
