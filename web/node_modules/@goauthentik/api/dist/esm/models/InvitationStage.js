 ...
 */
export function instanceOfInvitationStage(value) {
...
export function InvitationStageFromJSON(json) {
    return InvitationStageFromJSONTyped(json, false);
}
export function InvitationStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function InvitationStageToJSON(json) {
    return InvitationStageToJSONTyped(json, false);
}
export function InvitationStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
