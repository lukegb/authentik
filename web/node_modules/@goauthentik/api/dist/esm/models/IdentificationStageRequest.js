 ...
 */
export function instanceOfIdentificationStageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    return isInstance;
}
export function IdentificationStageRequestFromJSON(json) {
    return IdentificationStageRequestFromJSONTyped(json, false);
}
export function IdentificationStageRequestFromJSONTyped(json, ignoreDiscriminator) {
