...
export function AuthenticatorWebAuthnStageToJSONTyped(value?: Omit<AuthenticatorWebAuthnStage, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'device_type_restrictions_obj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
