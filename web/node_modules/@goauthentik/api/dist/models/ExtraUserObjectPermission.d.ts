 ...
 */
export declare function instanceOfExtraUserObjectPermission(value: object): value is ExtraUserObjectPermission;
...
export declare function ExtraUserObjectPermissionToJSON(json: any): ExtraUserObjectPermission;
export declare function ExtraUserObjectPermissionToJSONTyped(value?: Omit<ExtraUserObjectPermission, 'id' | 'codename' | 'model' | 'app_label' | 'name' | 'app_label_verbose' | 'model_verbose' | 'object_description'> | null, ignoreDiscriminator?: boolean): any;
