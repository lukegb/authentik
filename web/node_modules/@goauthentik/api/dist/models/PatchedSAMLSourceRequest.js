...
exports.instanceOfPatchedSAMLSourceRequest = instanceOfPatchedSAMLSourceRequest;
exports.PatchedSAMLSourceRequestFromJSON = PatchedSAMLSourceRequestFromJSON;
 ...
 */
function instanceOfPatchedSAMLSourceRequest(value) {
    return true;
}
function PatchedSAMLSourceRequestFromJSON(json) {
    return PatchedSAMLSourceRequestFromJSONTyped(json, false);
}
function PatchedSAMLSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'nameIdPolicy': json['name_id_policy'] == null ? undefined : (0, NameIdPolicyEnum_1.NameIdPolicyEnumFromJSON)(json['name_id_policy']),
...
function PatchedSAMLSourceRequestToJSON(json) {
    return PatchedSAMLSourceRequestToJSONTyped(json, false);
}
function PatchedSAMLSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
