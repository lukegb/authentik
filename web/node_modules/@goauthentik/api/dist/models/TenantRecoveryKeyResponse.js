...
exports.TenantRecoveryKeyResponseToJSONTyped = TenantRecoveryKeyResponseToJSONTyped;
/**
...
function TenantRecoveryKeyResponseToJSON(json) {
    return TenantRecoveryKeyResponseToJSONTyped(json, false);
}
function TenantRecoveryKeyResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
