 ...
 */
export function instanceOfPatchedOAuthSourceRequest(value) {
    return true;
}
export function PatchedOAuthSourceRequestFromJSON(json) {
    return PatchedOAuthSourceRequestFromJSONTyped(json, false);
}
export function PatchedOAuthSourceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedOAuthSourceRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
