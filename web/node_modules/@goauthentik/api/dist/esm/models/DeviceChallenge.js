 ...
 */
export function instanceOfDeviceChallenge(value) {
...
export function DeviceChallengeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DeviceChallengeToJSON(json) {
    return DeviceChallengeToJSONTyped(json, false);
}
export function DeviceChallengeToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
