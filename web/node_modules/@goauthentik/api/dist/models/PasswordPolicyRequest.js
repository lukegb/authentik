...
exports.instanceOfPasswordPolicyRequest = instanceOfPasswordPolicyRequest;
exports.PasswordPolicyRequestFromJSON = PasswordPolicyRequestFromJSON;
exports.PasswordPolicyRequestFromJSONTyped = PasswordPolicyRequestFromJSONTyped;
exports.PasswordPolicyRequestToJSON = PasswordPolicyRequestToJSON;
exports.PasswordPolicyRequestToJSONTyped = PasswordPolicyRequestToJSONTyped;
/**
 * Check if a given object implements the PasswordPolicyRequest interface.
 */
function instanceOfPasswordPolicyRequest(value) {
    if (!('name' in value) || value['name'] === undefined)
        return false;
    return true;
}
function PasswordPolicyRequestFromJSON(json) {
    return PasswordPolicyRequestFromJSONTyped(json, false);
}
function PasswordPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PasswordPolicyRequestToJSON(json) {
    return PasswordPolicyRequestToJSONTyped(json, false);
}
function PasswordPolicyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
