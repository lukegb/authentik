...
export function PaginatedGoogleWorkspaceProviderMappingListToJSON(json) {
    return PaginatedGoogleWorkspaceProviderMappingListToJSONTyped(json, false);
}
export function PaginatedGoogleWorkspaceProviderMappingListToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
