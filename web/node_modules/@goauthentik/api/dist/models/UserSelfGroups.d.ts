 ...
 */
export declare function instanceOfUserSelfGroups(value: object): value is UserSelfGroups;
...
export declare function UserSelfGroupsToJSON(json: any): UserSelfGroups;
export declare function UserSelfGroupsToJSONTyped(value?: Omit<UserSelfGroups, 'name' | 'pk'> | null, ignoreDiscriminator?: boolean): any;
