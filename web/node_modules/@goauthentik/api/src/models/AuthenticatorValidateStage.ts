...
export function AuthenticatorValidateStageToJSONTyped(value?: Omit<AuthenticatorValidateStage, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'webauthn_allowed_device_types_obj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
