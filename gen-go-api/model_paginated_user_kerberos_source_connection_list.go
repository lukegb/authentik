...
// checks if the PaginatedUserKerberosSourceConnectionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUserKerberosSourceConnectionList{}
...
func (o PaginatedUserKerberosSourceConnectionList) ToMap() (map[string]interface{}, error) {
