 ...
 */
export function instanceOfPropertyMapping(value) {
...
export function PropertyMappingFromJSON(json) {
    return PropertyMappingFromJSONTyped(json, false);
}
export function PropertyMappingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PropertyMappingToJSON(json) {
    return PropertyMappingToJSONTyped(json, false);
}
export function PropertyMappingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
