 ...
 */
export function instanceOfFlowSet(value) {
    ...
    if (!('title' in value) || value['title'] === undefined)
        return false;
    if (!('designation' in value) || value['designation'] === undefined)
        return false;
    if (!('background' in value) || value['background'] === undefined)
        return false;
    if (!('exportUrl' in value) || value['exportUrl'] === undefined)
        return false;
    return true;
}
export function FlowSetFromJSON(json) {
    return FlowSetFromJSONTyped(json, false);
}
export function FlowSetFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function FlowSetToJSON(json) {
    return FlowSetToJSONTyped(json, false);
}
export function FlowSetToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
