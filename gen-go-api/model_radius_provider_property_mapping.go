...
// checks if the RadiusProviderPropertyMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RadiusProviderPropertyMapping{}
...
func (o RadiusProviderPropertyMapping) ToMap() (map[string]interface{}, error) {
