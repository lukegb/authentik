...
exports.SCIMProviderUserToJSONTyped = SCIMProviderUserToJSONTyped;
...
function instanceOfSCIMProviderUser(value) {
    ...
    if (!('user' in value) || value['user'] === undefined)
        return false;
    if (!('userObj' in value) || value['userObj'] === undefined)
        return false;
...
function SCIMProviderUserToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
