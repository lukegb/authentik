...
exports.instanceOfExpressionPolicy = instanceOfExpressionPolicy;
exports.ExpressionPolicyFromJSON = ExpressionPolicyFromJSON;
exports.ExpressionPolicyFromJSONTyped = ExpressionPolicyFromJSONTyped;
exports.ExpressionPolicyToJSON = ExpressionPolicyToJSON;
exports.ExpressionPolicyToJSONTyped = ExpressionPolicyToJSONTyped;
/**
 * Check if a given object implements the ExpressionPolicy interface.
 */
function instanceOfExpressionPolicy(value) {
...
function ExpressionPolicyFromJSON(json) {
    return ExpressionPolicyFromJSONTyped(json, false);
}
function ExpressionPolicyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function ExpressionPolicyToJSON(json) {
    return ExpressionPolicyToJSONTyped(json, false);
}
function ExpressionPolicyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
