 ...
 */
export function instanceOfStage(value) {
...
export function StageFromJSON(json) {
    return StageFromJSONTyped(json, false);
}
export function StageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function StageToJSON(json) {
    return StageToJSONTyped(json, false);
}
export function StageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
