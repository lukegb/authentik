 ...
 */
export function instanceOfPatchedScopeMappingRequest(value) {
    return true;
}
export function PatchedScopeMappingRequestFromJSON(json) {
    return PatchedScopeMappingRequestFromJSONTyped(json, false);
}
export function PatchedScopeMappingRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedScopeMappingRequestToJSON(json) {
    return PatchedScopeMappingRequestToJSONTyped(json, false);
}
export function PatchedScopeMappingRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
