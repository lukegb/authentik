...
exports.FlowSetRequestToJSON = exports.FlowSetRequestFromJSONTyped = exports.FlowSetRequestFromJSON = exports.instanceOfFlowSetRequest = void 0;
 ...
 */
function instanceOfFlowSetRequest(value) {
    let isInstance = true;
...
exports.instanceOfFlowSetRequest = instanceOfFlowSetRequest;
function FlowSetRequestFromJSON(json) {
    return FlowSetRequestFromJSONTyped(json, false);
}
exports.FlowSetRequestFromJSON = FlowSetRequestFromJSON;
function FlowSetRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.FlowSetRequestFromJSONTyped = FlowSetRequestFromJSONTyped;
function FlowSetRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FlowSetRequestToJSON = FlowSetRequestToJSON;
