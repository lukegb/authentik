...
export declare function PermissionToJSONTyped(value?: Omit<Permission, 'id' | 'model' | 'app_label' | 'app_label_verbose' | 'model_verbose'> | null, ignoreDiscriminator?: boolean): any;
