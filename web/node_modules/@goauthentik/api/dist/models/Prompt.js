...
exports.PromptToJSONTyped = PromptToJSONTyped;
...
function PromptFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'promptstageSet': json['promptstage_set'] == null ? undefined : (json['promptstage_set'].map(Stage_1.StageFromJSON)),
...
function PromptToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        ...
        'order': value['order'],
        'promptstage_set': value['promptstageSet'] == null ? undefined : (value['promptstageSet'].map(Stage_1.StageToJSON)),
