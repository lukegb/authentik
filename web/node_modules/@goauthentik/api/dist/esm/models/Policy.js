 ...
 */
export function instanceOfPolicy(value) {
    let isInstance = true;
...
export function PolicyFromJSON(json) {
    return PolicyFromJSONTyped(json, false);
}
export function PolicyFromJSONTyped(json, ignoreDiscriminator) {
...
export function PolicyToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
