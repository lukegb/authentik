...
exports.SettingsRequestToJSONTyped = SettingsRequestToJSONTyped;
/**
...
function SettingsRequestToJSON(json) {
    return SettingsRequestToJSONTyped(json, false);
}
function SettingsRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
