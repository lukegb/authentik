 ...
 */
export function instanceOfPatchedEmailStageRequest(value) {
    return true;
}
export function PatchedEmailStageRequestFromJSON(json) {
    return PatchedEmailStageRequestFromJSONTyped(json, false);
}
export function PatchedEmailStageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedEmailStageRequestToJSON(json) {
    return PatchedEmailStageRequestToJSONTyped(json, false);
}
export function PatchedEmailStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
