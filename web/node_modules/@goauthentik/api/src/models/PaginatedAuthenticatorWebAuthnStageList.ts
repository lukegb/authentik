...
import {
    ...
    AuthenticatorWebAuthnStageToJSONTyped,
 ...
 */
export function instanceOfPaginatedAuthenticatorWebAuthnStageList(value: object): value is PaginatedAuthenticatorWebAuthnStageList {
...
export function PaginatedAuthenticatorWebAuthnStageListToJSON(json: any): PaginatedAuthenticatorWebAuthnStageList {
    return PaginatedAuthenticatorWebAuthnStageListToJSONTyped(json, false);
}

export function PaginatedAuthenticatorWebAuthnStageListToJSONTyped(value?: PaginatedAuthenticatorWebAuthnStageList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
