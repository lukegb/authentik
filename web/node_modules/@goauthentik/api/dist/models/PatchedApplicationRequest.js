...
exports.PatchedApplicationRequestToJSONTyped = PatchedApplicationRequestToJSONTyped;
...
function PatchedApplicationRequestToJSON(json) {
    return PatchedApplicationRequestToJSONTyped(json, false);
}
function PatchedApplicationRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
