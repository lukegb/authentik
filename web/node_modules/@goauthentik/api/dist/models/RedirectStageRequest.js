...
exports.RedirectStageRequestToJSONTyped = RedirectStageRequestToJSONTyped;
...
function RedirectStageRequestToJSON(json) {
    return RedirectStageRequestToJSONTyped(json, false);
}
function RedirectStageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
