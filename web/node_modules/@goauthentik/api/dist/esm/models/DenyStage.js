 ...
 */
export function instanceOfDenyStage(value) {
...
export function DenyStageFromJSON(json) {
    return DenyStageFromJSONTyped(json, false);
}
export function DenyStageFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DenyStageToJSON(json) {
    return DenyStageToJSONTyped(json, false);
}
export function DenyStageToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
