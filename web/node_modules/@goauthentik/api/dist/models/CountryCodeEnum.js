...
exports.instanceOfCountryCodeEnum = instanceOfCountryCodeEnum;
...
exports.CountryCodeEnumToJSONTyped = CountryCodeEnumToJSONTyped;
/**
 *
 * @export
 */
...
function instanceOfCountryCodeEnum(value) {
    for (const key in exports.CountryCodeEnum) {
        if (Object.prototype.hasOwnProperty.call(exports.CountryCodeEnum, key)) {
            if (exports.CountryCodeEnum[key] === value) {
                return true;
            }
        }
    }
...
function CountryCodeEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
