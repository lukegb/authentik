...
exports.CertificateKeyPairFromJSON = CertificateKeyPairFromJSON;
...
exports.CertificateKeyPairToJSONTyped = CertificateKeyPairToJSONTyped;
/**
 * Check if a given object implements the CertificateKeyPair interface.
 */
function instanceOfCertificateKeyPair(value) {
    ...
    if (!('fingerprintSha256' in value) || value['fingerprintSha256'] === undefined)
        return false;
    if (!('fingerprintSha1' in value) || value['fingerprintSha1'] === undefined)
        return false;
    if (!('certExpiry' in value) || value['certExpiry'] === undefined)
        return false;
    if (!('certSubject' in value) || value['certSubject'] === undefined)
        return false;
    if (!('privateKeyAvailable' in value) || value['privateKeyAvailable'] === undefined)
        return false;
    if (!('privateKeyType' in value) || value['privateKeyType'] === undefined)
        return false;
...
function CertificateKeyPairFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CertificateKeyPairToJSON(json) {
    return CertificateKeyPairToJSONTyped(json, false);
}
function CertificateKeyPairToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
